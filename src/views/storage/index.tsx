...
import { TemplateData, TemplateField, SolcerySchema, Template, Storage, TplObject } from "../../solcery/classes"
  ...
  if (storage && template && objects)
  {
    ...
    <div style = {divStyle}>
      <Table dataSource={tableData} >
        ...
        />
        {template.fields.map((field: TemplateField) => { return <Column title={field.name} key={field.id} dataIndex={field.id} />} )}
      </Table>
