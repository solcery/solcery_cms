function unityFramework(Module) {
  ...
  function _OnNodeEditorLoaded() {
    ReactUnityWebGL.OnNodeEditorLoaded()
  }
  function _SaveBrickTree(brickTree) {
  ...
  var asmLibraryArg = {
    fe: _JS_Accelerometer_IsRunning,
    Ua: _JS_Accelerometer_Start,
    ee: _JS_Accelerometer_Stop,
    ke: _JS_Cursor_SetImage,
    na: _JS_Cursor_SetShow,
    pa: _JS_DOM_MapViewportCoordinateToElementLocalCoordinate,
    Pf: _JS_DOM_UnityCanvasSelector,
    Id: _JS_FileSystem_Initialize,
    S: _JS_FileSystem_Sync,
    be: _JS_GravitySensor_IsRunning,
    Ra: _JS_GravitySensor_Start,
    ae: _JS_GravitySensor_Stop,
    $d: _JS_Gyroscope_IsRunning,
    Qa: _JS_Gyroscope_Start,
    _d: _JS_Gyroscope_Stop,
    de: _JS_LinearAccelerationSensor_IsRunning,
    Ta: _JS_LinearAccelerationSensor_Start,
    ce: _JS_LinearAccelerationSensor_Stop,
    cc: _JS_Log_Dump,
    Md: _JS_Log_StackTrace,
    he: _JS_OrientationSensor_IsRunning,
    Va: _JS_OrientationSensor_Start,
    ge: _JS_OrientationSensor_Stop,
    Za: _JS_RequestDeviceSensorPermissionsOnTouch,
    Cd: _JS_RunQuitCallbacks,
    Zd: _JS_ScreenOrientation_DeInit,
    je: _JS_ScreenOrientation_Init,
    R: _JS_ScreenOrientation_Lock,
    _a: _JS_Sound_ResumeIfNeeded,
    Yd: _JS_SystemInfo_GetCanvasClientSize,
    re: _JS_SystemInfo_GetDocumentURL,
    Gd: _JS_SystemInfo_GetGPUInfo,
    Pa: _JS_SystemInfo_GetMatchWebGLToCanvasSize,
    Ka: _JS_SystemInfo_GetMemory,
    Ld: _JS_SystemInfo_GetOS,
    Na: _JS_SystemInfo_GetPreferredDevicePixelRatio,
    Od: _JS_SystemInfo_GetScreenSize,
    He: _JS_SystemInfo_GetStreamingAssetsURL,
    me: _JS_SystemInfo_HasAstcHdr,
    Ma: _JS_SystemInfo_HasCursorLock,
    Xd: _JS_SystemInfo_HasFullscreen,
    ba: _JS_SystemInfo_HasWebGL,
    Kd: _JS_UnityEngineShouldQuit,
    Be: _JS_WebRequest_Abort,
    ye: _JS_WebRequest_Create,
    ze: _JS_WebRequest_GetResponseHeaders,
    Ae: _JS_WebRequest_Release,
    se: _JS_WebRequest_Send,
    ve: _JS_WebRequest_SetProgressHandler,
    ue: _JS_WebRequest_SetRequestHeader,
    we: _JS_WebRequest_SetResponseHandler,
    xe: _JS_WebRequest_SetTimeout,
    Ba: _OnNodeEditorLoaded,
    Ug: _SaveBrickTree,
    ...
    _b: ___cxa_find_matching_catch_4,
    jc: ___cxa_rethrow,
    ca: ___cxa_throw,
    tc: ___gmtime_r,
    uc: ___localtime_r,
    k: ___resumeException,
    zc: ___sys__newselect,
    Ec: ___sys_accept4,
    Ac: ___sys_access,
    cd: ___sys_bind,
    gc: ___sys_chmod,
    ...
    H: ___sys_fcntl64,
    ie: ___sys_fstat64,
    Wd: ___sys_ftruncate64,
    dc: ___sys_getcwd,
    $b: ___sys_getdents64,
    Yb: ___sys_getegid32,
    Zb: ___sys_geteuid32,
    pc: ___sys_getpeername,
    ha: ___sys_getpid,
    yc: ___sys_getrusage,
    Gc: ___sys_getsockname,
    Tc: ___sys_getsockopt,
    Ge: ___sys_getuid32,
    Ja: ___sys_ioctl,
    Fc: ___sys_listen,
    hc: ___sys_lstat64,
    ...
    mc: ___sys_sendmsg,
    Dc: ___sys_sendto,
    Bc: ___sys_setsockopt,
    oc: ___sys_shutdown,
    Ea: ___sys_socket,
    Sa: ___sys_stat64,
    Ce: ___sys_statfs64,
    Ee: ___sys_truncate64,
    vc: ___sys_uname,
    fc: ___sys_unlink,
    y: _abort,
    G: _clock,
    ...
    La: _dlopen,
    yd: _dlsym,
    jb: _emscripten_asm_const_int_sync_on_main_thread,
    Dd: _emscripten_cancel_main_loop,
    Bd: _emscripten_clear_interval,
    Ud: _emscripten_exit_fullscreen,
    Pd: _emscripten_exit_pointerlock,
    Nd: _emscripten_get_canvas_element_size,
    Td: _emscripten_get_fullscreen_status,
    Wa: _emscripten_get_gamepad_status,
    te: _emscripten_get_heap_max,
    F: _emscripten_get_now,
    Xa: _emscripten_get_num_gamepads,
    Ed: _emscripten_html5_remove_all_event_listeners,
    oe: _emscripten_is_webgl_context_lost,
    x: _emscripten_log,
    Zg: _emscripten_memcpy_big,
    Vd: _emscripten_request_fullscreen,
    Qd: _emscripten_request_pointerlock,
    _g: _emscripten_resize_heap,
    Ya: _emscripten_sample_gamepad_data,
    Oa: _emscripten_set_blur_callback_on_thread,
    oa: _emscripten_set_canvas_element_size,
    Rd: _emscripten_set_focus_callback_on_thread,
    Sd: _emscripten_set_fullscreenchange_callback_on_thread,
    ab: _emscripten_set_gamepadconnected_callback_on_thread,
    $a: _emscripten_set_gamepaddisconnected_callback_on_thread,
    Hd: _emscripten_set_interval,
    ...
    bb: _emscripten_set_touchcancel_callback_on_thread,
    db: _emscripten_set_touchend_callback_on_thread,
    cb: _emscripten_set_touchmove_callback_on_thread,
    eb: _emscripten_set_touchstart_callback_on_thread,
    fb: _emscripten_set_wheel_callback_on_thread,
    le: _emscripten_thread_sleep,
    qe: _emscripten_webgl_create_context,
    pe: _emscripten_webgl_destroy_context,
    $: _emscripten_webgl_enable_extension,
    ne: _emscripten_webgl_get_current_context,
    Ie: _emscripten_webgl_init_context_attributes,
    sa: _emscripten_webgl_make_context_current,
    lc: _environ_get,
    sc: _environ_sizes_get,
    ea: _exit,
    P: _fd_close,
    Ia: _fd_fdstat_get,
    Ha: _fd_read,
    ...
    fa: _glBindAttribLocation,
    Fg: _glBindBuffer,
    We: _glBindBufferBase,
    Ve: _glBindBufferRange,
    Cg: _glBindFramebuffer,
    Dg: _glBindRenderbuffer,
    Qe: _glBindSampler,
    Eg: _glBindTexture,
    of: _glBindTransformFeedback,
    rf: _glBindVertexArray,
    Ob: _glBlendEquation,
    Pb: _glBlendEquationSeparate,
    Qb: _glBlendFuncSeparate,
    ff: _glBlitFramebuffer,
    Ag: _glBufferData,
    Bg: _glBufferSubData,
    zg: _glCheckFramebufferStatus,
    vg: _glClear,
    Me: _glClearBufferfi,
    Le: _glClearBufferfv,
    Je: _glClearBufferuiv,
    wg: _glClearColor,
    xg: _glClearDepthf,
    yg: _glClearStencil,
    ...
    Nb: _glColorMask,
    ug: _glCompileShader,
    sg: _glCompressedTexImage2D,
    hf: _glCompressedTexImage3D,
    tg: _glCompressedTexSubImage2D,
    mf: _glCompressedTexSubImage3D,
    Ze: _glCopyBufferSubData,
    rg: _glCopyTexImage2D,
    Mb: _glCopyTexSubImage2D,
    qg: _glCreateProgram,
    pg: _glCreateShader,
    og: _glCullFace,
    ng: _glDeleteBuffers,
    ...
    hg: _glDetachShader,
    gg: _glDisable,
    fg: _glDisableVertexAttribArray,
    cg: _glDrawArrays,
    $e: _glDrawArraysInstanced,
    Ye: _glDrawBuffers,
    dg: _glDrawElements,
    _e: _glDrawElementsInstanced,
    eg: _glEnable,
    bg: _glEnableVertexAttribArray,
    sb: _glEndQuery,
    wf: _glEndTransformFeedback,
    kb: _glFenceSync,
    _f: _glFinish,
    $f: _glFlush,
    cf: _glFlushMappedBufferRange,
    J: _glFramebufferRenderbuffer,
    I: _glFramebufferTexture2D,
    va: _glFramebufferTextureLayer,
    Jb: _glFrontFace,
    Zf: _glGenBuffers,
    Vf: _glGenFramebuffers,
    pb: _glGenQueries,
    Wf: _glGenRenderbuffers,
    Oe: _glGenSamplers,
    Yf: _glGenTextures,
    qf: _glGenTransformFeedbacks,
    uf: _glGenVertexArrays,
    Xf: _glGenerateMipmap,
    Pg: _glGetActiveAttrib,
    Aa: _glGetActiveUniform,
    ua: _glGetActiveUniformBlockName,
    T: _glGetActiveUniformBlockiv,
    Q: _glGetActiveUniformsiv,
    Og: _glGetAttribLocation,
    Uf: _glGetError,
    Tf: _glGetFramebufferAttachmentParameteriv,
    Ig: _glGetIntegeri_v,
    ga: _glGetIntegerv,
    Se: _glGetInternalformativ,
    mb: _glGetProgramBinary,
    Lg: _glGetProgramInfoLog,
    L: _glGetProgramiv,
    yf: _glGetQueryObjectuiv,
    xf: _glGetQueryiv,
    ag: _glGetRenderbufferParameteriv,
    Rf: _glGetShaderInfoLog,
    Ib: _glGetShaderPrecisionFormat,
    Sf: _glGetShaderSource,
    Kg: _glGetShaderiv,
    Qf: _glGetString,
    df: _glGetStringi,
    Of: _glGetTexParameteriv,
    Te: _glGetUniformBlockIndex,
    ta: _glGetUniformIndices,
    W: _glGetUniformLocation,
    Hb: _glGetUniformiv,
    Ng: _glGetVertexAttribiv,
    wa: _glInvalidateFramebuffer,
    Hg: _glIsEnabled,
    sf: _glIsVertexArray,
    Mf: _glLinkProgram,
    af: _glMapBufferRange,
    Nf: _glPixelStorei,
    Gb: _glPolygonOffset,
    nb: _glProgramBinary,
    Ne: _glProgramParameteri,
    Xe: _glReadBuffer,
    V: _glReadPixels,
    Lf: _glRenderbufferStorage,
    ef: _glRenderbufferStorageMultisample,
    Re: _glSamplerParameteri,
    Fb: _glScissor,
    Jf: _glShaderSource,
    Kf: _glStencilFuncSeparate,
    Hf: _glStencilMask,
    ...
    Cb: _glUniform4iv,
    Db: _glUniform4uiv,
    ob: _glUniformBlockBinding,
    Eb: _glUniformMatrix3fv,
    ya: _glUniformMatrix4fv,
    bf: _glUnmapBuffer,
    zf: _glUseProgram,
    Mg: _glValidateProgram,
    Af: _glVertexAttrib4f,
    Bf: _glVertexAttrib4fv,
    Ue: _glVertexAttribIPointer,
    Cf: _glVertexAttribPointer,
    tb: _glViewport,
    Rg: invoke_ddiii,
    Tb: invoke_dii,
    Uc: invoke_dji,
    ...
    D: invoke_iiiiiiiii,
    M: invoke_iiiiiiiiii,
    Rb: invoke_iiiiiiiiiii,
    Xg: invoke_iiiiiiiiiiiii,
    ...
    E: invoke_viiiiiiii,
    N: invoke_viiiiiiiii,
    Ub: invoke_viiiiiiiiifi,
    Ca: invoke_viiiiiiiiii,
    Sb: invoke_viiiiiiiiiiii,
    ed: invoke_viiiiij,
    fd: invoke_viiij,
    Xc: invoke_viij,
    Vc: invoke_viiji,
    pd: invoke_viijii,
    Mc: invoke_viijiiiiii,
    $c: invoke_viijiiijiiii,
    Wc: invoke_viji,
    od: invoke_vijii,
    Pc: invoke_vijiii,
    Yc: invoke_vijjji,
  ...
  var _SendMessage = (Module['_SendMessage'] = function () {
    return (_SendMessage = Module['_SendMessage'] = Module['asm']['dh']).apply(
      null,
      arguments,
    )
  })
  ...
  var _main = (Module['_main'] = function () {
    return (_main = Module['_main'] = Module['asm']['fh']).apply(
      null,
      arguments,
    )
  })
  ...
  var _htonl = (Module['_htonl'] = function () {
    return (_htonl = Module['_htonl'] = Module['asm']['hh']).apply(
      null,
      arguments,
    )
  })
  var _htons = (Module['_htons'] = function () {
    return (_htons = Module['_htons'] = Module['asm']['ih']).apply(
      null,
      arguments,
    )
  })
  var _ntohs = (Module['_ntohs'] = function () {
    return (_ntohs = Module['_ntohs'] = Module['asm']['jh']).apply(
      null,
      arguments,
    )
  })
  var __get_tzname = (Module['__get_tzname'] = function () {
    return (__get_tzname = Module['__get_tzname'] = Module['asm']['kh']).apply(
      null,
      arguments,
    )
  })
  ...
  var stackSave = (Module['stackSave'] = function () {
    return (stackSave = Module['stackSave'] = Module['asm']['nh']).apply(
      null,
      arguments,
    )
  })
  var stackRestore = (Module['stackRestore'] = function () {
    return (stackRestore = Module['stackRestore'] = Module['asm']['oh']).apply(
      null,
      arguments,
    )
  })
  var stackAlloc = (Module['stackAlloc'] = function () {
    return (stackAlloc = Module['stackAlloc'] = Module['asm']['ph']).apply(
      null,
      arguments,
    )
  })
  ...
  var _malloc = (Module['_malloc'] = function () {
    return (_malloc = Module['_malloc'] = Module['asm']['rh']).apply(
      null,
      arguments,
    )
  })
  var _free = (Module['_free'] = function () {
    return (_free = Module['_free'] = Module['asm']['sh']).apply(
      null,
      arguments,
    )
  })
  var _memalign = (Module['_memalign'] = function () {
    return (_memalign = Module['_memalign'] = Module['asm']['th']).apply(
      null,
      arguments,
    )
  })
  var _memset = (Module['_memset'] = function () {
    return (_memset = Module['_memset'] = Module['asm']['uh']).apply(
      null,
      arguments,
    )
  })
  var _strlen = (Module['_strlen'] = function () {
    return (_strlen = Module['_strlen'] = Module['asm']['vh']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vii = (Module['dynCall_vii'] = function () {
    return (dynCall_vii = Module['dynCall_vii'] = Module['asm']['yh']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iii = (Module['dynCall_iii'] = function () {
    return (dynCall_iii = Module['dynCall_iii'] = Module['asm']['zh']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ii = (Module['dynCall_ii'] = function () {
    return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['Ah']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iiii = (Module['dynCall_iiii'] = function () {
    return (dynCall_iiii = Module['dynCall_iiii'] = Module['asm']['Bh']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jiji = (Module['dynCall_jiji'] = function () {
    return (dynCall_jiji = Module['dynCall_jiji'] = Module['asm']['Ch']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_i = (Module['dynCall_i'] = function () {
    return (dynCall_i = Module['dynCall_i'] = Module['asm']['Eh']).apply(
      null,
      arguments,
    )
  })
  var dynCall_v = (Module['dynCall_v'] = function () {
    return (dynCall_v = Module['dynCall_v'] = Module['asm']['Fh']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viii = (Module['dynCall_viii'] = function () {
    return (dynCall_viii = Module['dynCall_viii'] = Module['asm']['Kh']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iiij = (Module['dynCall_iiij'] = function () {
    return (dynCall_iiij = Module['dynCall_iiij'] = Module['asm']['Lh']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iij = (Module['dynCall_iij'] = function () {
    return (dynCall_iij = Module['dynCall_iij'] = Module['asm']['Ph']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jii = (Module['dynCall_jii'] = function () {
    return (dynCall_jii = Module['dynCall_jii'] = Module['asm']['Rh']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_j = (Module['dynCall_j'] = function () {
    return (dynCall_j = Module['dynCall_j'] = Module['asm']['hi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ji = (Module['dynCall_ji'] = function () {
    return (dynCall_ji = Module['dynCall_ji'] = Module['asm']['ii']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jijj = (Module['dynCall_jijj'] = function () {
    return (dynCall_jijj = Module['dynCall_jijj'] = Module['asm']['ji']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vji = (Module['dynCall_vji'] = function () {
    return (dynCall_vji = Module['dynCall_vji'] = Module['asm']['li']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fii = (Module['dynCall_fii'] = function () {
    return (dynCall_fii = Module['dynCall_fii'] = Module['asm']['pi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vifi = (Module['dynCall_vifi'] = function () {
    return (dynCall_vifi = Module['dynCall_vifi'] = Module['asm']['wi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fi = (Module['dynCall_fi'] = function () {
    return (dynCall_fi = Module['dynCall_fi'] = Module['asm']['xi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fiii = (Module['dynCall_fiii'] = function () {
    return (dynCall_fiii = Module['dynCall_fiii'] = Module['asm']['Fi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jjji = (Module['dynCall_jjji'] = function () {
    return (dynCall_jjji = Module['dynCall_jjji'] = Module['asm']['Ii']).apply(
      null,
      arguments,
    )
  })
  var dynCall_dii = (Module['dynCall_dii'] = function () {
    return (dynCall_dii = Module['dynCall_dii'] = Module['asm']['Ji']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jiii = (Module['dynCall_jiii'] = function () {
    return (dynCall_jiii = Module['dynCall_jiii'] = Module['asm']['Li']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ijji = (Module['dynCall_ijji'] = function () {
    return (dynCall_ijji = Module['dynCall_ijji'] = Module['asm']['Mi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jdi = (Module['dynCall_jdi'] = function () {
    return (dynCall_jdi = Module['dynCall_jdi'] = Module['asm']['Ni']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viij = (Module['dynCall_viij'] = function () {
    return (dynCall_viij = Module['dynCall_viij'] = Module['asm']['Pi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vidi = (Module['dynCall_vidi'] = function () {
    return (dynCall_vidi = Module['dynCall_vidi'] = Module['asm']['Qi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_viji = (Module['dynCall_viji'] = function () {
    return (dynCall_viji = Module['dynCall_viji'] = Module['asm']['Ri']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_dji = (Module['dynCall_dji'] = function () {
    return (dynCall_dji = Module['dynCall_dji'] = Module['asm']['Wi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iiji = (Module['dynCall_iiji'] = function () {
    return (dynCall_iiji = Module['dynCall_iiji'] = Module['asm']['Yi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iji = (Module['dynCall_iji'] = function () {
    return (dynCall_iji = Module['dynCall_iji'] = Module['asm']['_i']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iifi = (Module['dynCall_iifi'] = function () {
    return (dynCall_iifi = Module['dynCall_iifi'] = Module['asm']['gj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_idii = (Module['dynCall_idii'] = function () {
    return (dynCall_idii = Module['dynCall_idii'] = Module['asm']['lj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jji = (Module['dynCall_jji'] = function () {
    return (dynCall_jji = Module['dynCall_jji'] = Module['asm']['mj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jjii = (Module['dynCall_jjii'] = function () {
    return (dynCall_jjii = Module['dynCall_jjii'] = Module['asm']['nj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iddi = (Module['dynCall_iddi'] = function () {
    return (dynCall_iddi = Module['dynCall_iddi'] = Module['asm']['sj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_diii = (Module['dynCall_diii'] = function () {
    return (dynCall_diii = Module['dynCall_diii'] = Module['asm']['uj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iffi = (Module['dynCall_iffi'] = function () {
    return (dynCall_iffi = Module['dynCall_iffi'] = Module['asm']['Nj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ifi = (Module['dynCall_ifi'] = function () {
    return (dynCall_ifi = Module['dynCall_ifi'] = Module['asm']['Oj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ffi = (Module['dynCall_ffi'] = function () {
    return (dynCall_ffi = Module['dynCall_ffi'] = Module['asm']['Vj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ffii = (Module['dynCall_ffii'] = function () {
    return (dynCall_ffii = Module['dynCall_ffii'] = Module['asm']['Wj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_dddi = (Module['dynCall_dddi'] = function () {
    return (dynCall_dddi = Module['dynCall_dddi'] = Module['asm']['Zj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ddi = (Module['dynCall_ddi'] = function () {
    return (dynCall_ddi = Module['dynCall_ddi'] = Module['asm']['_j']).apply(
      null,
      arguments,
    )
  })
  var dynCall_idi = (Module['dynCall_idi'] = function () {
    return (dynCall_idi = Module['dynCall_idi'] = Module['asm']['$j']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ijii = (Module['dynCall_ijii'] = function () {
    return (dynCall_ijii = Module['dynCall_ijii'] = Module['asm']['ek']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iidi = (Module['dynCall_iidi'] = function () {
    return (dynCall_iidi = Module['dynCall_iidi'] = Module['asm']['ik']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jidi = (Module['dynCall_jidi'] = function () {
    return (dynCall_jidi = Module['dynCall_jidi'] = Module['asm']['jk']).apply(
      null,
      arguments,
    )
  })
  var dynCall_diji = (Module['dynCall_diji'] = function () {
    return (dynCall_diji = Module['dynCall_diji'] = Module['asm']['kk']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fidi = (Module['dynCall_fidi'] = function () {
    return (dynCall_fidi = Module['dynCall_fidi'] = Module['asm']['lk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vffi = (Module['dynCall_vffi'] = function () {
    return (dynCall_vffi = Module['dynCall_vffi'] = Module['asm']['ok']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fffi = (Module['dynCall_fffi'] = function () {
    return (dynCall_fffi = Module['dynCall_fffi'] = Module['asm']['uk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vfi = (Module['dynCall_vfi'] = function () {
    return (dynCall_vfi = Module['dynCall_vfi'] = Module['asm']['yk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vjii = (Module['dynCall_vjii'] = function () {
    return (dynCall_vjii = Module['dynCall_vjii'] = Module['asm']['Qk']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fifi = (Module['dynCall_fifi'] = function () {
    return (dynCall_fifi = Module['dynCall_fifi'] = Module['asm']['Rk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jfi = (Module['dynCall_jfi'] = function () {
    return (dynCall_jfi = Module['dynCall_jfi'] = Module['asm']['Wl']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fji = (Module['dynCall_fji'] = function () {
    return (dynCall_fji = Module['dynCall_fji'] = Module['asm']['Xl']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fdi = (Module['dynCall_fdi'] = function () {
    return (dynCall_fdi = Module['dynCall_fdi'] = Module['asm']['Yl']).apply(
      null,
      arguments,
    )
  })
  var dynCall_dfi = (Module['dynCall_dfi'] = function () {
    return (dynCall_dfi = Module['dynCall_dfi'] = Module['asm']['Zl']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ddii = (Module['dynCall_ddii'] = function () {
    return (dynCall_ddii = Module['dynCall_ddii'] = Module['asm']['mm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jdii = (Module['dynCall_jdii'] = function () {
    return (dynCall_jdii = Module['dynCall_jdii'] = Module['asm']['tm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vfii = (Module['dynCall_vfii'] = function () {
    return (dynCall_vfii = Module['dynCall_vfii'] = Module['asm']['um']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vdii = (Module['dynCall_vdii'] = function () {
    return (dynCall_vdii = Module['dynCall_vdii'] = Module['asm']['vm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_didi = (Module['dynCall_didi'] = function () {
    return (dynCall_didi = Module['dynCall_didi'] = Module['asm']['ym']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_di = (Module['dynCall_di'] = function () {
    return (dynCall_di = Module['dynCall_di'] = Module['asm']['Hm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ijj = (Module['dynCall_ijj'] = function () {
    return (dynCall_ijj = Module['dynCall_ijj'] = Module['asm']['Om']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vjji = (Module['dynCall_vjji'] = function () {
    return (dynCall_vjji = Module['dynCall_vjji'] = Module['asm']['Pm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ij = (Module['dynCall_ij'] = function () {
    return (dynCall_ij = Module['dynCall_ij'] = Module['asm']['Qm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_viif = (Module['dynCall_viif'] = function () {
    return (dynCall_viif = Module['dynCall_viif'] = Module['asm']['Rm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vid = (Module['dynCall_vid'] = function () {
    return (dynCall_vid = Module['dynCall_vid'] = Module['asm']['Sm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vif = (Module['dynCall_vif'] = function () {
    return (dynCall_vif = Module['dynCall_vif'] = Module['asm']['Tm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vf = (Module['dynCall_vf'] = function () {
    return (dynCall_vf = Module['dynCall_vf'] = Module['asm']['$m']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vff = (Module['dynCall_vff'] = function () {
    return (dynCall_vff = Module['dynCall_vff'] = Module['asm']['bn']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viff = (Module['dynCall_viff'] = function () {
    return (dynCall_viff = Module['dynCall_viff'] = Module['asm']['fn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vij = (Module['dynCall_vij'] = function () {
    return (dynCall_vij = Module['dynCall_vij'] = Module['asm']['gn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fff = (Module['dynCall_fff'] = function () {
    return (dynCall_fff = Module['dynCall_fff'] = Module['asm']['hn']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_f = (Module['dynCall_f'] = function () {
    return (dynCall_f = Module['dynCall_f'] = Module['asm']['kn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vfff = (Module['dynCall_vfff'] = function () {
    return (dynCall_vfff = Module['dynCall_vfff'] = Module['asm']['ln']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ff = (Module['dynCall_ff'] = function () {
    return (dynCall_ff = Module['dynCall_ff'] = Module['asm']['nn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fiif = (Module['dynCall_fiif'] = function () {
    return (dynCall_fiif = Module['dynCall_fiif'] = Module['asm']['on']).apply(
      null,
      arguments,
    )
  })
