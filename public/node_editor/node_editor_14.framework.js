function unityFramework(Module) {
  ...
  var asmLibraryArg = {
    be: _JS_Accelerometer_IsRunning,
    ib: _JS_Accelerometer_Start,
    hb: _JS_Accelerometer_Stop,
    ge: _JS_Cursor_SetImage,
    ya: _JS_Cursor_SetShow,
    wa: _JS_DOM_MapViewportCoordinateToElementLocalCoordinate,
    Pf: _JS_DOM_UnityCanvasSelector,
    Hd: _JS_FileSystem_Initialize,
    W: _JS_FileSystem_Sync,
    $d: _JS_GravitySensor_IsRunning,
    eb: _JS_GravitySensor_Start,
    db: _JS_GravitySensor_Stop,
    _d: _JS_Gyroscope_IsRunning,
    cb: _JS_Gyroscope_Start,
    bb: _JS_Gyroscope_Stop,
    ae: _JS_LinearAccelerationSensor_IsRunning,
    gb: _JS_LinearAccelerationSensor_Start,
    fb: _JS_LinearAccelerationSensor_Stop,
    de: _JS_Log_Dump,
    Od: _JS_Log_StackTrace,
    ce: _JS_OrientationSensor_IsRunning,
    kb: _JS_OrientationSensor_Start,
    jb: _JS_OrientationSensor_Stop,
    ob: _JS_RequestDeviceSensorPermissionsOnTouch,
    Kd: _JS_RunQuitCallbacks,
    Zd: _JS_ScreenOrientation_DeInit,
    ee: _JS_ScreenOrientation_Init,
    U: _JS_ScreenOrientation_Lock,
    pb: _JS_Sound_ResumeIfNeeded,
    Y: _JS_SystemInfo_GetCanvasClientSize,
    Cb: _JS_SystemInfo_GetDocumentURL,
    Wa: _JS_SystemInfo_GetGPUInfo,
    ab: _JS_SystemInfo_GetMatchWebGLToCanvasSize,
    Xa: _JS_SystemInfo_GetMemory,
    Ya: _JS_SystemInfo_GetOS,
    _a: _JS_SystemInfo_GetPreferredDevicePixelRatio,
    Qd: _JS_SystemInfo_GetScreenSize,
    Ab: _JS_SystemInfo_GetStreamingAssetsURL,
    he: _JS_SystemInfo_HasAstcHdr,
    Za: _JS_SystemInfo_HasCursorLock,
    Yd: _JS_SystemInfo_HasFullscreen,
    ca: _JS_SystemInfo_HasWebGL,
    Nd: _JS_UnityEngineShouldQuit,
    ue: _JS_WebRequest_Abort,
    te: _JS_WebRequest_Create,
    Db: _JS_WebRequest_GetResponseHeaders,
    ...
    J: ___sys_fcntl64,
    Mg: ___sys_fstat64,
    vg: ___sys_ftruncate64,
    sc: ___sys_getcwd,
    pc: ___sys_getdents64,
    ec: ___sys_getegid32,
    fc: ___sys_geteuid32,
    Ec: ___sys_getpeername,
    oa: ___sys_getpid,
    Nc: ___sys_getrusage,
    mf: ___sys_getsockname,
    zf: ___sys_getsockopt,
    ze: ___sys_getuid32,
    Va: ___sys_ioctl,
    af: ___sys_listen,
    wc: ___sys_lstat64,
    ...
    Ld: _emscripten_cancel_main_loop,
    Jd: _emscripten_clear_interval,
    Wd: _emscripten_exit_fullscreen,
    Rd: _emscripten_exit_pointerlock,
    Pd: _emscripten_get_canvas_element_size,
    Vd: _emscripten_get_fullscreen_status,
    lb: _emscripten_get_gamepad_status,
    $g: _emscripten_get_heap_max,
    E: _emscripten_get_now,
    mb: _emscripten_get_num_gamepads,
    Md: _emscripten_html5_remove_all_event_listeners,
    ke: _emscripten_is_webgl_context_lost,
    x: _emscripten_log,
    bh: _emscripten_memcpy_big,
    Xd: _emscripten_request_fullscreen,
    Sd: _emscripten_request_pointerlock,
    ...
    Td: _emscripten_set_focus_callback_on_thread,
    ...
    Id: _emscripten_set_main_loop_timing,
    ...
    Zg: _emscripten_thread_sleep,
    me: _emscripten_webgl_create_context,
    le: _emscripten_webgl_destroy_context,
    $: _emscripten_webgl_enable_extension,
    je: _emscripten_webgl_get_current_context,
    Ae: _emscripten_webgl_init_context_attributes,
    ...
    Ig: _glAttachShader,
    Jb: _glBeginQuery,
    qf: _glBeginTransformFeedback,
    ka: _glBindAttribLocation,
    Hg: _glBindBuffer,
    Oe: _glBindBufferBase,
    Ne: _glBindBufferRange,
    Eg: _glBindFramebuffer,
    Fg: _glBindRenderbuffer,
    Ie: _glBindSampler,
    Gg: _glBindTexture,
    hf: _glBindTransformFeedback,
    ...
    Cg: _glBufferData,
    Dg: _glBufferSubData,
    Bg: _glCheckFramebufferStatus,
    xg: _glClear,
    De: _glClearBufferfi,
    Ce: _glClearBufferfv,
    Be: _glClearBufferuiv,
    yg: _glClearColor,
    zg: _glClearDepthf,
    Ag: _glClearStencil,
    ...
    bf: _glCompressedTexImage3D,
    ug: _glCompressedTexSubImage2D,
    ff: _glCompressedTexSubImage3D,
    Re: _glCopyBufferSubData,
    ...
    pg: _glCullFace,
    og: _glDeleteBuffers,
    ng: _glDeleteFramebuffers,
    mg: _glDeleteProgram,
    Ea: _glDeleteQueries,
    lg: _glDeleteRenderbuffers,
    He: _glDeleteSamplers,
    kg: _glDeleteShader,
    Fb: _glDeleteSync,
    jg: _glDeleteTextures,
    jf: _glDeleteTransformFeedbacks,
    of: _glDeleteVertexArrays,
    ja: _glDepthFunc,
    ia: _glDepthMask,
    ig: _glDetachShader,
    hg: _glDisable,
    gg: _glDisableVertexAttribArray,
    dg: _glDrawArrays,
    ...
    fg: _glEnable,
    cg: _glEnableVertexAttribArray,
    Kb: _glEndQuery,
    rf: _glEndTransformFeedback,
    Eb: _glFenceSync,
    $f: _glFinish,
    ag: _glFlush,
    ...
    pf: _glGenVertexArrays,
    Xf: _glGenerateMipmap,
    Sg: _glGetActiveAttrib,
    Ja: _glGetActiveUniform,
    Ba: _glGetActiveUniformBlockName,
    R: _glGetActiveUniformBlockiv,
    Q: _glGetActiveUniformsiv,
    Rg: _glGetAttribLocation,
    Uf: _glGetError,
    Tf: _glGetFramebufferAttachmentParameteriv,
    Kg: _glGetIntegeri_v,
    la: _glGetIntegerv,
    Ke: _glGetInternalformativ,
    Gb: _glGetProgramBinary,
    Og: _glGetProgramInfoLog,
    M: _glGetProgramiv,
    uf: _glGetQueryObjectuiv,
    sf: _glGetQueryiv,
    bg: _glGetRenderbufferParameteriv,
    Rf: _glGetShaderInfoLog,
    Yb: _glGetShaderPrecisionFormat,
    Sf: _glGetShaderSource,
    Ng: _glGetShaderiv,
    Qf: _glGetString,
    Ye: _glGetStringi,
    Nf: _glGetTexParameteriv,
    Le: _glGetUniformBlockIndex,
    Aa: _glGetUniformIndices,
    V: _glGetUniformLocation,
    Xb: _glGetUniformiv,
    Qg: _glGetVertexAttribiv,
    ...
    Wb: _glPolygonOffset,
    Hb: _glProgramBinary,
    Fe: _glProgramParameteri,
    Pe: _glReadBuffer,
    T: _glReadPixels,
    Kf: _glRenderbufferStorage,
    Ze: _glRenderbufferStorageMultisample,
    Je: _glSamplerParameteri,
    Ia: _glScissor,
    Hf: _glShaderSource,
    Jf: _glStencilFuncSeparate,
    Ff: _glStencilMask,
    Gf: _glStencilOpSeparate,
    Df: _glTexImage2D,
    df: _glTexImage3D,
    Ef: _glTexParameterf,
    Ha: _glTexParameteri,
    Cf: _glTexParameteriv,
    $e: _glTexStorage2D,
    cf: _glTexStorage3D,
    Bf: _glTexSubImage2D,
    ef: _glTexSubImage3D,
    gf: _glTransformFeedbackVaryings,
    Lb: _glUniform1fv,
    ea: _glUniform1i,
    Mb: _glUniform1iv,
    Nb: _glUniform1uiv,
    ...
    Vb: _glUniformMatrix3fv,
    fa: _glUniformMatrix4fv,
    We: _glUnmapBuffer,
    wf: _glUseProgram,
    Pg: _glValidateProgram,
    xf: _glVertexAttrib4f,
    yf: _glVertexAttrib4fv,
    Me: _glVertexAttribIPointer,
    Af: _glVertexAttribPointer,
    Fa: _glViewport,
    Vg: invoke_ddiii,
    kc: invoke_dii,
    nc: invoke_diii,
  ...
  var _htonl = (Module['_htonl'] = function () {
    return (_htonl = Module['_htonl'] = Module['asm']['lh']).apply(
      null,
      arguments,
    )
  })
  var _htons = (Module['_htons'] = function () {
    return (_htons = Module['_htons'] = Module['asm']['mh']).apply(
      null,
      arguments,
    )
  })
  var _ntohs = (Module['_ntohs'] = function () {
    return (_ntohs = Module['_ntohs'] = Module['asm']['nh']).apply(
      null,
      arguments,
    )
  })
  var __get_tzname = (Module['__get_tzname'] = function () {
    return (__get_tzname = Module['__get_tzname'] = Module['asm']['oh']).apply(
      null,
      arguments,
    )
  })
  ...
  var stackRestore = (Module['stackRestore'] = function () {
    return (stackRestore = Module['stackRestore'] = Module['asm']['sh']).apply(
      null,
      arguments,
    )
  })
  ...
  var _setThrew = (Module['_setThrew'] = function () {
    return (_setThrew = Module['_setThrew'] = Module['asm']['uh']).apply(
      null,
      arguments,
    )
  })
  var _malloc = (Module['_malloc'] = function () {
    return (_malloc = Module['_malloc'] = Module['asm']['vh']).apply(
      null,
      arguments,
    )
  })
  var _free = (Module['_free'] = function () {
    return (_free = Module['_free'] = Module['asm']['wh']).apply(
      null,
      arguments,
    )
  })
  var _memalign = (Module['_memalign'] = function () {
    return (_memalign = Module['_memalign'] = Module['asm']['xh']).apply(
      null,
      arguments,
    )
  })
  var _memset = (Module['_memset'] = function () {
    return (_memset = Module['_memset'] = Module['asm']['yh']).apply(
      null,
      arguments,
    )
  })
  var _strlen = (Module['_strlen'] = function () {
    return (_strlen = Module['_strlen'] = Module['asm']['zh']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vii = (Module['dynCall_vii'] = function () {
    return (dynCall_vii = Module['dynCall_vii'] = Module['asm']['Ch']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iii = (Module['dynCall_iii'] = function () {
    return (dynCall_iii = Module['dynCall_iii'] = Module['asm']['Dh']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ii = (Module['dynCall_ii'] = function () {
    return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['Eh']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iiii = (Module['dynCall_iiii'] = function () {
    return (dynCall_iiii = Module['dynCall_iiii'] = Module['asm']['Fh']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jiji = (Module['dynCall_jiji'] = function () {
    return (dynCall_jiji = Module['dynCall_jiji'] = Module['asm']['Gh']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vi = (Module['dynCall_vi'] = function () {
    return (dynCall_vi = Module['dynCall_vi'] = Module['asm']['Hh']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viii = (Module['dynCall_viii'] = function () {
    return (dynCall_viii = Module['dynCall_viii'] = Module['asm']['Jh']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_i = (Module['dynCall_i'] = function () {
    return (dynCall_i = Module['dynCall_i'] = Module['asm']['Oh']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iij = (Module['dynCall_iij'] = function () {
    return (dynCall_iij = Module['dynCall_iij'] = Module['asm']['Th']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jii = (Module['dynCall_jii'] = function () {
    return (dynCall_jii = Module['dynCall_jii'] = Module['asm']['Vh']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fiii = (Module['dynCall_fiii'] = function () {
    return (dynCall_fiii = Module['dynCall_fiii'] = Module['asm']['bi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jiii = (Module['dynCall_jiii'] = function () {
    return (dynCall_jiii = Module['dynCall_jiii'] = Module['asm']['ci']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_diii = (Module['dynCall_diii'] = function () {
    return (dynCall_diii = Module['dynCall_diii'] = Module['asm']['fi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viif = (Module['dynCall_viif'] = function () {
    return (dynCall_viif = Module['dynCall_viif'] = Module['asm']['li']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ji = (Module['dynCall_ji'] = function () {
    return (dynCall_ji = Module['dynCall_ji'] = Module['asm']['ni']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jjji = (Module['dynCall_jjji'] = function () {
    return (dynCall_jjji = Module['dynCall_jjji'] = Module['asm']['oi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_dii = (Module['dynCall_dii'] = function () {
    return (dynCall_dii = Module['dynCall_dii'] = Module['asm']['pi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jdi = (Module['dynCall_jdi'] = function () {
    return (dynCall_jdi = Module['dynCall_jdi'] = Module['asm']['ti']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viji = (Module['dynCall_viji'] = function () {
    return (dynCall_viji = Module['dynCall_viji'] = Module['asm']['xi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fii = (Module['dynCall_fii'] = function () {
    return (dynCall_fii = Module['dynCall_fii'] = Module['asm']['yi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iiji = (Module['dynCall_iiji'] = function () {
    return (dynCall_iiji = Module['dynCall_iiji'] = Module['asm']['Hi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iidi = (Module['dynCall_iidi'] = function () {
    return (dynCall_iidi = Module['dynCall_iidi'] = Module['asm']['Ii']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iifi = (Module['dynCall_iifi'] = function () {
    return (dynCall_iifi = Module['dynCall_iifi'] = Module['asm']['Ji']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fifi = (Module['dynCall_fifi'] = function () {
    return (dynCall_fifi = Module['dynCall_fifi'] = Module['asm']['Ki']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_j = (Module['dynCall_j'] = function () {
    return (dynCall_j = Module['dynCall_j'] = Module['asm']['Yi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jijj = (Module['dynCall_jijj'] = function () {
    return (dynCall_jijj = Module['dynCall_jijj'] = Module['asm']['Zi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vji = (Module['dynCall_vji'] = function () {
    return (dynCall_vji = Module['dynCall_vji'] = Module['asm']['$i']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_dji = (Module['dynCall_dji'] = function () {
    return (dynCall_dji = Module['dynCall_dji'] = Module['asm']['cj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iji = (Module['dynCall_iji'] = function () {
    return (dynCall_iji = Module['dynCall_iji'] = Module['asm']['kj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fi = (Module['dynCall_fi'] = function () {
    return (dynCall_fi = Module['dynCall_fi'] = Module['asm']['lj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viij = (Module['dynCall_viij'] = function () {
    return (dynCall_viij = Module['dynCall_viij'] = Module['asm']['nj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vidi = (Module['dynCall_vidi'] = function () {
    return (dynCall_vidi = Module['dynCall_vidi'] = Module['asm']['oj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_idii = (Module['dynCall_idii'] = function () {
    return (dynCall_idii = Module['dynCall_idii'] = Module['asm']['zj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jji = (Module['dynCall_jji'] = function () {
    return (dynCall_jji = Module['dynCall_jji'] = Module['asm']['Aj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jjii = (Module['dynCall_jjii'] = function () {
    return (dynCall_jjii = Module['dynCall_jjii'] = Module['asm']['Bj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iddi = (Module['dynCall_iddi'] = function () {
    return (dynCall_iddi = Module['dynCall_iddi'] = Module['asm']['Gj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iffi = (Module['dynCall_iffi'] = function () {
    return (dynCall_iffi = Module['dynCall_iffi'] = Module['asm']['Zj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ifi = (Module['dynCall_ifi'] = function () {
    return (dynCall_ifi = Module['dynCall_ifi'] = Module['asm']['$j']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ffi = (Module['dynCall_ffi'] = function () {
    return (dynCall_ffi = Module['dynCall_ffi'] = Module['asm']['fk']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ffii = (Module['dynCall_ffii'] = function () {
    return (dynCall_ffii = Module['dynCall_ffii'] = Module['asm']['gk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_dddi = (Module['dynCall_dddi'] = function () {
    return (dynCall_dddi = Module['dynCall_dddi'] = Module['asm']['jk']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ddi = (Module['dynCall_ddi'] = function () {
    return (dynCall_ddi = Module['dynCall_ddi'] = Module['asm']['kk']).apply(
      null,
      arguments,
    )
  })
  var dynCall_idi = (Module['dynCall_idi'] = function () {
    return (dynCall_idi = Module['dynCall_idi'] = Module['asm']['lk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ijii = (Module['dynCall_ijii'] = function () {
    return (dynCall_ijii = Module['dynCall_ijii'] = Module['asm']['pk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jidi = (Module['dynCall_jidi'] = function () {
    return (dynCall_jidi = Module['dynCall_jidi'] = Module['asm']['tk']).apply(
      null,
      arguments,
    )
  })
  var dynCall_diji = (Module['dynCall_diji'] = function () {
    return (dynCall_diji = Module['dynCall_diji'] = Module['asm']['uk']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fidi = (Module['dynCall_fidi'] = function () {
    return (dynCall_fidi = Module['dynCall_fidi'] = Module['asm']['vk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vffi = (Module['dynCall_vffi'] = function () {
    return (dynCall_vffi = Module['dynCall_vffi'] = Module['asm']['yk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fffi = (Module['dynCall_fffi'] = function () {
    return (dynCall_fffi = Module['dynCall_fffi'] = Module['asm']['Ek']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vfi = (Module['dynCall_vfi'] = function () {
    return (dynCall_vfi = Module['dynCall_vfi'] = Module['asm']['Ik']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vjii = (Module['dynCall_vjii'] = function () {
    return (dynCall_vjii = Module['dynCall_vjii'] = Module['asm']['Zk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jfi = (Module['dynCall_jfi'] = function () {
    return (dynCall_jfi = Module['dynCall_jfi'] = Module['asm']['bm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fji = (Module['dynCall_fji'] = function () {
    return (dynCall_fji = Module['dynCall_fji'] = Module['asm']['cm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fdi = (Module['dynCall_fdi'] = function () {
    return (dynCall_fdi = Module['dynCall_fdi'] = Module['asm']['dm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_dfi = (Module['dynCall_dfi'] = function () {
    return (dynCall_dfi = Module['dynCall_dfi'] = Module['asm']['em']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ddii = (Module['dynCall_ddii'] = function () {
    return (dynCall_ddii = Module['dynCall_ddii'] = Module['asm']['sm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jdii = (Module['dynCall_jdii'] = function () {
    return (dynCall_jdii = Module['dynCall_jdii'] = Module['asm']['zm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vfii = (Module['dynCall_vfii'] = function () {
    return (dynCall_vfii = Module['dynCall_vfii'] = Module['asm']['Am']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vdii = (Module['dynCall_vdii'] = function () {
    return (dynCall_vdii = Module['dynCall_vdii'] = Module['asm']['Bm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_didi = (Module['dynCall_didi'] = function () {
    return (dynCall_didi = Module['dynCall_didi'] = Module['asm']['Em']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_di = (Module['dynCall_di'] = function () {
    return (dynCall_di = Module['dynCall_di'] = Module['asm']['Nm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ijj = (Module['dynCall_ijj'] = function () {
    return (dynCall_ijj = Module['dynCall_ijj'] = Module['asm']['an']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vjji = (Module['dynCall_vjji'] = function () {
    return (dynCall_vjji = Module['dynCall_vjji'] = Module['asm']['bn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ij = (Module['dynCall_ij'] = function () {
    return (dynCall_ij = Module['dynCall_ij'] = Module['asm']['cn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vif = (Module['dynCall_vif'] = function () {
    return (dynCall_vif = Module['dynCall_vif'] = Module['asm']['dn']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vid = (Module['dynCall_vid'] = function () {
    return (dynCall_vid = Module['dynCall_vid'] = Module['asm']['fn']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viff = (Module['dynCall_viff'] = function () {
    return (dynCall_viff = Module['dynCall_viff'] = Module['asm']['rn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vij = (Module['dynCall_vij'] = function () {
    return (dynCall_vij = Module['dynCall_vij'] = Module['asm']['sn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fff = (Module['dynCall_fff'] = function () {
    return (dynCall_fff = Module['dynCall_fff'] = Module['asm']['tn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vf = (Module['dynCall_vf'] = function () {
    return (dynCall_vf = Module['dynCall_vf'] = Module['asm']['un']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vff = (Module['dynCall_vff'] = function () {
    return (dynCall_vff = Module['dynCall_vff'] = Module['asm']['wn']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_f = (Module['dynCall_f'] = function () {
    return (dynCall_f = Module['dynCall_f'] = Module['asm']['yn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vfff = (Module['dynCall_vfff'] = function () {
    return (dynCall_vfff = Module['dynCall_vfff'] = Module['asm']['zn']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ff = (Module['dynCall_ff'] = function () {
    return (dynCall_ff = Module['dynCall_ff'] = Module['asm']['Bn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fiif = (Module['dynCall_fiif'] = function () {
    return (dynCall_fiif = Module['dynCall_fiif'] = Module['asm']['Cn']).apply(
      null,
      arguments,
    )
  })
