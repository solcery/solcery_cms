function unityFramework(Module) {
        ...
        newDevices.forEach(function (device) {
          if (!device.id) {
            ...
            if (
              ...
              (device.name || '').toLowerCase().indexOf('front') != -1
            )
  ...
  var wr = { requestInstances: {}, nextRequestId: 1 }
  ...
  function _JS_WebRequest_Create(url, method) {
    ...
    var http =
      Module.companyName && Module.productName && Module.XMLHttpRequest
  ...
  function _OnGameOverPopupButtonClicked() {
    ReactUnityWebGL.OnGameOverPopupButtonClicked()
  }
  function _OnUnityLoaded(message) {
  ...
  var asmLibraryArg = {
    dc: _CastCard,
    ze: _JS_Accelerometer_IsRunning,
    db: _JS_Accelerometer_Start,
    ye: _JS_Accelerometer_Stop,
    Ee: _JS_Cursor_SetImage,
    va: _JS_Cursor_SetShow,
    ya: _JS_DOM_MapViewportCoordinateToElementLocalCoordinate,
    Ig: _JS_DOM_UnityCanvasSelector,
    $d: _JS_FileSystem_Initialize,
    V: _JS_FileSystem_Sync,
    ve: _JS_GravitySensor_IsRunning,
    bb: _JS_GravitySensor_Start,
    te: _JS_GravitySensor_Stop,
    se: _JS_Gyroscope_IsRunning,
    ab: _JS_Gyroscope_Start,
    re: _JS_Gyroscope_Stop,
    xe: _JS_LinearAccelerationSensor_IsRunning,
    cb: _JS_LinearAccelerationSensor_Start,
    we: _JS_LinearAccelerationSensor_Stop,
    sc: _JS_Log_Dump,
    de: _JS_Log_StackTrace,
    Be: _JS_OrientationSensor_IsRunning,
    eb: _JS_OrientationSensor_Start,
    Ae: _JS_OrientationSensor_Stop,
    ib: _JS_RequestDeviceSensorPermissionsOnTouch,
    Vd: _JS_RunQuitCallbacks,
    qe: _JS_ScreenOrientation_DeInit,
    Ce: _JS_ScreenOrientation_Init,
    $: _JS_ScreenOrientation_Lock,
    jb: _JS_Sound_ResumeIfNeeded,
    pe: _JS_SystemInfo_GetCanvasClientSize,
    Ne: _JS_SystemInfo_GetDocumentURL,
    Zd: _JS_SystemInfo_GetGPUInfo,
    _a: _JS_SystemInfo_GetMatchWebGLToCanvasSize,
    Wa: _JS_SystemInfo_GetMemory,
    ce: _JS_SystemInfo_GetOS,
    Ya: _JS_SystemInfo_GetPreferredDevicePixelRatio,
    ge: _JS_SystemInfo_GetScreenSize,
    af: _JS_SystemInfo_GetStreamingAssetsURL,
    Ge: _JS_SystemInfo_HasAstcHdr,
    Xa: _JS_SystemInfo_HasCursorLock,
    oe: _JS_SystemInfo_HasFullscreen,
    la: _JS_SystemInfo_HasWebGL,
    Fe: _JS_SystemInfo_IsMobile,
    be: _JS_UnityEngineShouldQuit,
    Xe: _JS_WebRequest_Abort,
    Te: _JS_WebRequest_Create,
    Ve: _JS_WebRequest_GetResponseHeaders,
    We: _JS_WebRequest_Release,
    Oe: _JS_WebRequest_Send,
    Qe: _JS_WebRequest_SetProgressHandler,
    Pe: _JS_WebRequest_SetRequestHeader,
    Re: _JS_WebRequest_SetResponseHandler,
    Se: _JS_WebRequest_SetTimeout,
    ec: _OnGameOverPopupButtonClicked,
    ph: _OnUnityLoaded,
    oh: _OpenLinkInNewTab,
    Fh: _WebGLInputCreate,
    hc: _WebGLInputDelete,
    Eh: _WebGLInputEnterSubmit,
    La: _WebGLInputFocus,
    gc: _WebGLInputForceBlur,
    jc: _WebGLInputInit,
    vh: _WebGLInputIsFocus,
    xh: _WebGLInputMaxLength,
    Gh: _WebGLInputMobileOnFocusOut,
    Hh: _WebGLInputMobileRegister,
    Bh: _WebGLInputOnBlur,
    zh: _WebGLInputOnEditEnd,
    Ch: _WebGLInputOnFocus,
    Ah: _WebGLInputOnValueChange,
    ic: _WebGLInputSelectionDirection,
    Ja: _WebGLInputSelectionEnd,
    Ka: _WebGLInputSelectionStart,
    yh: _WebGLInputSetSelectionRange,
    Dh: _WebGLInputTab,
    wh: _WebGLInputText,
    fc: _WebGLWindowInjectFullscreen,
    th: _WebGLWindowOnBlur,
    uh: _WebGLWindowOnFocus,
    sh: _WebGLWindowOnResize,
    o: ___cxa_allocate_exception,
    j: ___cxa_begin_catch,
    p: ___cxa_end_catch,
    i: ___cxa_find_matching_catch_2,
    a: ___cxa_find_matching_catch_3,
    Mh: ___cxa_find_matching_catch_4,
    Ab: ___cxa_free_exception,
    De: ___cxa_rethrow,
    X: ___cxa_throw,
    Gc: ___gmtime_r,
    Hc: ___localtime_r,
    l: ___resumeException,
    Nc: ___sys__newselect,
    Sc: ___sys_accept4,
    Oc: ___sys_access,
    id: ___sys_bind,
    vc: ___sys_chmod,
    ...
    M: ___sys_fcntl64,
    ue: ___sys_fstat64,
    fe: ___sys_ftruncate64,
    rc: ___sys_getcwd,
    oc: ___sys_getdents64,
    bc: ___sys_getegid32,
    cc: ___sys_geteuid32,
    Dc: ___sys_getpeername,
    pa: ___sys_getpid,
    Mc: ___sys_getrusage,
    Uc: ___sys_getsockname,
    Zc: ___sys_getsockopt,
    $e: ___sys_getuid32,
    Ua: ___sys_ioctl,
    Tc: ___sys_listen,
    wc: ___sys_lstat64,
    ...
    Va: _dlopen,
    Ed: _dlsym,
    ub: _emscripten_asm_const_int_sync_on_main_thread,
    Wd: _emscripten_cancel_main_loop,
    Ud: _emscripten_clear_interval,
    me: _emscripten_exit_fullscreen,
    he: _emscripten_exit_pointerlock,
    ee: _emscripten_get_canvas_element_size,
    le: _emscripten_get_fullscreen_status,
    fb: _emscripten_get_gamepad_status,
    Ue: _emscripten_get_heap_max,
    J: _emscripten_get_now,
    gb: _emscripten_get_num_gamepads,
    Xd: _emscripten_html5_remove_all_event_listeners,
    Ie: _emscripten_is_webgl_context_lost,
    z: _emscripten_log,
    E: _emscripten_longjmp,
    Nh: _emscripten_memcpy_big,
    ne: _emscripten_request_fullscreen,
    ie: _emscripten_request_pointerlock,
    Oh: _emscripten_resize_heap,
    hb: _emscripten_sample_gamepad_data,
    Za: _emscripten_set_blur_callback_on_thread,
    wa: _emscripten_set_canvas_element_size,
    je: _emscripten_set_focus_callback_on_thread,
    ...
    sb: _emscripten_set_mousedown_callback_on_thread,
    rb: _emscripten_set_mousemove_callback_on_thread,
    tb: _emscripten_set_mouseup_callback_on_thread,
    mb: _emscripten_set_touchcancel_callback_on_thread,
    ob: _emscripten_set_touchend_callback_on_thread,
    nb: _emscripten_set_touchmove_callback_on_thread,
    pb: _emscripten_set_touchstart_callback_on_thread,
    qb: _emscripten_set_wheel_callback_on_thread,
    Le: _emscripten_thread_sleep,
    Ke: _emscripten_webgl_create_context,
    Je: _emscripten_webgl_destroy_context,
    ja: _emscripten_webgl_enable_extension,
    He: _emscripten_webgl_get_current_context,
    cf: _emscripten_webgl_init_context_attributes,
    Aa: _emscripten_webgl_make_context_current,
    Cc: _environ_get,
    Ic: _environ_sizes_get,
    ea: _exit,
    S: _fd_close,
    Ta: _fd_fdstat_get,
    Sa: _fd_read,
    ...
    ah: _glAttachShader,
    Db: _glBeginQuery,
    Rf: _glBeginTransformFeedback,
    na: _glBindAttribLocation,
    $g: _glBindBuffer,
    rf: _glBindBufferBase,
    qf: _glBindBufferRange,
    Yg: _glBindFramebuffer,
    Zg: _glBindRenderbuffer,
    lf: _glBindSampler,
    _g: _glBindTexture,
    Kf: _glBindTransformFeedback,
    Nf: _glBindVertexArray,
    _b: _glBlendEquation,
    $b: _glBlendEquationSeparate,
    ac: _glBlendFuncSeparate,
    Cf: _glBlitFramebuffer,
    Wg: _glBufferData,
    Xg: _glBufferSubData,
    Vg: _glCheckFramebufferStatus,
    Rg: _glClear,
    ff: _glClearBufferfi,
    ef: _glClearBufferfv,
    df: _glClearBufferuiv,
    Sg: _glClearColor,
    Tg: _glClearDepthf,
    Ug: _glClearStencil,
    Xc: _glClientWaitSync,
    Zb: _glColorMask,
    Qg: _glCompileShader,
    Og: _glCompressedTexImage2D,
    Ef: _glCompressedTexImage3D,
    Pg: _glCompressedTexSubImage2D,
    If: _glCompressedTexSubImage3D,
    uf: _glCopyBufferSubData,
    Ng: _glCopyTexImage2D,
    Yb: _glCopyTexSubImage2D,
    Mg: _glCreateProgram,
    Lg: _glCreateShader,
    Kg: _glCullFace,
    Jg: _glDeleteBuffers,
    Hg: _glDeleteFramebuffers,
    Gg: _glDeleteProgram,
    Cb: _glDeleteQueries,
    ...
    Eg: _glDeleteShader,
    wb: _glDeleteSync,
    Dg: _glDeleteTextures,
    Lf: _glDeleteTransformFeedbacks,
    Pf: _glDeleteVertexArrays,
    Xb: _glDepthFunc,
    Wb: _glDepthMask,
    Cg: _glDetachShader,
    Bg: _glDisable,
    Ag: _glDisableVertexAttribArray,
    xg: _glDrawArrays,
    wf: _glDrawArraysInstanced,
    tf: _glDrawBuffers,
    yg: _glDrawElements,
    vf: _glDrawElementsInstanced,
    zg: _glEnable,
    wg: _glEnableVertexAttribArray,
    Eb: _glEndQuery,
    Sf: _glEndTransformFeedback,
    vb: _glFenceSync,
    tg: _glFinish,
    ug: _glFlush,
    zf: _glFlushMappedBufferRange,
    O: _glFramebufferRenderbuffer,
    N: _glFramebufferTexture2D,
    Da: _glFramebufferTextureLayer,
    Vb: _glFrontFace,
    sg: _glGenBuffers,
    og: _glGenFramebuffers,
    Bb: _glGenQueries,
    pg: _glGenRenderbuffers,
    jf: _glGenSamplers,
    rg: _glGenTextures,
    Mf: _glGenTransformFeedbacks,
    Qf: _glGenVertexArrays,
    qg: _glGenerateMipmap,
    jh: _glGetActiveAttrib,
    Ia: _glGetActiveUniform,
    Ca: _glGetActiveUniformBlockName,
    aa: _glGetActiveUniformBlockiv,
    W: _glGetActiveUniformsiv,
    ih: _glGetAttribLocation,
    ng: _glGetError,
    mg: _glGetFramebufferAttachmentParameteriv,
    ch: _glGetIntegeri_v,
    oa: _glGetIntegerv,
    ...
    R: _glGetProgramiv,
    Uf: _glGetQueryObjectuiv,
    Tf: _glGetQueryiv,
    vg: _glGetRenderbufferParameteriv,
    kg: _glGetShaderInfoLog,
    Ub: _glGetShaderPrecisionFormat,
    lg: _glGetShaderSource,
    eh: _glGetShaderiv,
    jg: _glGetString,
    Af: _glGetStringi,
    ig: _glGetTexParameteriv,
    ...
    Of: _glIsVertexArray,
    gg: _glLinkProgram,
    xf: _glMapBufferRange,
    hg: _glPixelStorei,
    Sb: _glPolygonOffset,
    yb: _glProgramBinary,
    hf: _glProgramParameteri,
    sf: _glReadBuffer,
    ca: _glReadPixels,
    fg: _glRenderbufferStorage,
    Bf: _glRenderbufferStorageMultisample,
    mf: _glSamplerParameteri,
    Rb: _glScissor,
    dg: _glShaderSource,
    eg: _glStencilFuncSeparate,
    bg: _glStencilMask,
    cg: _glStencilOpSeparate,
    $f: _glTexImage2D,
    Gf: _glTexImage3D,
    ag: _glTexParameterf,
    Ha: _glTexParameteri,
    _f: _glTexParameteriv,
    Df: _glTexStorage2D,
    Ff: _glTexStorage3D,
    Zf: _glTexSubImage2D,
    Hf: _glTexSubImage3D,
    Jf: _glTransformFeedbackVaryings,
    Gb: _glUniform1fv,
    ma: _glUniform1i,
    Hb: _glUniform1iv,
    Ib: _glUniform1uiv,
    ...
    Qb: _glUniformMatrix3fv,
    Ga: _glUniformMatrix4fv,
    yf: _glUnmapBuffer,
    Vf: _glUseProgram,
    gh: _glValidateProgram,
    Wf: _glVertexAttrib4f,
    Xf: _glVertexAttrib4fv,
    pf: _glVertexAttribIPointer,
    Yf: _glVertexAttribPointer,
    Fb: _glViewport,
    Kh: invoke_ddiii,
    A: invoke_dii,
    _: invoke_diii,
    ...
    s: invoke_viiiiii,
    C: invoke_viiiiiii,
    lh: invoke_viiiiiiifiifii,
    G: invoke_viiiiiiii,
    K: invoke_viiiiiiiii,
    lc: invoke_viiiiiiiiifi,
    fa: invoke_viiiiiiiiii,
    kc: invoke_viiiiiiiiiiii,
    ed: invoke_viiiiij,
    dd: invoke_viiiijii,
    Gd: invoke_viiij,
    fd: invoke_viiiji,
  ...
  var _SendMessage = (Module['_SendMessage'] = function () {
    return (_SendMessage = Module['_SendMessage'] = Module['asm']['Th']).apply(
      null,
      arguments,
    )
  })
  ...
  var _main = (Module['_main'] = function () {
    return (_main = Module['_main'] = Module['asm']['Vh']).apply(
      null,
      arguments,
    )
  })
  ...
  var _htonl = (Module['_htonl'] = function () {
    return (_htonl = Module['_htonl'] = Module['asm']['Xh']).apply(
      null,
      arguments,
    )
  })
  var _htons = (Module['_htons'] = function () {
    return (_htons = Module['_htons'] = Module['asm']['Yh']).apply(
      null,
      arguments,
    )
  })
  var _ntohs = (Module['_ntohs'] = function () {
    return (_ntohs = Module['_ntohs'] = Module['asm']['Zh']).apply(
      null,
      arguments,
    )
  })
  var __get_tzname = (Module['__get_tzname'] = function () {
    return (__get_tzname = Module['__get_tzname'] = Module['asm']['_h']).apply(
      null,
      arguments,
    )
  })
  ...
  var stackSave = (Module['stackSave'] = function () {
    return (stackSave = Module['stackSave'] = Module['asm']['bi']).apply(
      null,
      arguments,
    )
  })
  var stackRestore = (Module['stackRestore'] = function () {
    return (stackRestore = Module['stackRestore'] = Module['asm']['ci']).apply(
      null,
      arguments,
    )
  })
  var stackAlloc = (Module['stackAlloc'] = function () {
    return (stackAlloc = Module['stackAlloc'] = Module['asm']['di']).apply(
      null,
      arguments,
    )
  })
  var _setThrew = (Module['_setThrew'] = function () {
    return (_setThrew = Module['_setThrew'] = Module['asm']['ei']).apply(
      null,
      arguments,
    )
  })
  ...
  var _malloc = (Module['_malloc'] = function () {
    return (_malloc = Module['_malloc'] = Module['asm']['hi']).apply(
      null,
      arguments,
    )
  })
  var _free = (Module['_free'] = function () {
    return (_free = Module['_free'] = Module['asm']['ii']).apply(
      null,
      arguments,
    )
  })
  var _memalign = (Module['_memalign'] = function () {
    return (_memalign = Module['_memalign'] = Module['asm']['ji']).apply(
      null,
      arguments,
    )
  })
  var _memset = (Module['_memset'] = function () {
    return (_memset = Module['_memset'] = Module['asm']['ki']).apply(
      null,
      arguments,
    )
  })
  var _strlen = (Module['_strlen'] = function () {
    return (_strlen = Module['_strlen'] = Module['asm']['li']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vii = (Module['dynCall_vii'] = function () {
    return (dynCall_vii = Module['dynCall_vii'] = Module['asm']['oi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iii = (Module['dynCall_iii'] = function () {
    return (dynCall_iii = Module['dynCall_iii'] = Module['asm']['pi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ii = (Module['dynCall_ii'] = function () {
    return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['qi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iiii = (Module['dynCall_iiii'] = function () {
    return (dynCall_iiii = Module['dynCall_iiii'] = Module['asm']['ri']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jiji = (Module['dynCall_jiji'] = function () {
    return (dynCall_jiji = Module['dynCall_jiji'] = Module['asm']['si']).apply(
      null,
      arguments,
    )
  })
  var dynCall_v = (Module['dynCall_v'] = function () {
    return (dynCall_v = Module['dynCall_v'] = Module['asm']['ti']).apply(
      null,
      arguments,
    )
  })
  var dynCall_i = (Module['dynCall_i'] = function () {
    return (dynCall_i = Module['dynCall_i'] = Module['asm']['ui']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viii = (Module['dynCall_viii'] = function () {
    return (dynCall_viii = Module['dynCall_viii'] = Module['asm']['Ai']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iiij = (Module['dynCall_iiij'] = function () {
    return (dynCall_iiij = Module['dynCall_iiij'] = Module['asm']['Bi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iij = (Module['dynCall_iij'] = function () {
    return (dynCall_iij = Module['dynCall_iij'] = Module['asm']['Fi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jii = (Module['dynCall_jii'] = function () {
    return (dynCall_jii = Module['dynCall_jii'] = Module['asm']['Hi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iji = (Module['dynCall_iji'] = function () {
    return (dynCall_iji = Module['dynCall_iji'] = Module['asm']['Ii']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_dii = (Module['dynCall_dii'] = function () {
    return (dynCall_dii = Module['dynCall_dii'] = Module['asm']['Ni']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vidi = (Module['dynCall_vidi'] = function () {
    return (dynCall_vidi = Module['dynCall_vidi'] = Module['asm']['Oi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vifi = (Module['dynCall_vifi'] = function () {
    return (dynCall_vifi = Module['dynCall_vifi'] = Module['asm']['Pi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viij = (Module['dynCall_viij'] = function () {
    return (dynCall_viij = Module['dynCall_viij'] = Module['asm']['Vi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jiii = (Module['dynCall_jiii'] = function () {
    return (dynCall_jiii = Module['dynCall_jiii'] = Module['asm']['Wi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fi = (Module['dynCall_fi'] = function () {
    return (dynCall_fi = Module['dynCall_fi'] = Module['asm']['bj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ji = (Module['dynCall_ji'] = function () {
    return (dynCall_ji = Module['dynCall_ji'] = Module['asm']['ej']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fiii = (Module['dynCall_fiii'] = function () {
    return (dynCall_fiii = Module['dynCall_fiii'] = Module['asm']['fj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_diii = (Module['dynCall_diii'] = function () {
    return (dynCall_diii = Module['dynCall_diii'] = Module['asm']['hj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ijji = (Module['dynCall_ijji'] = function () {
    return (dynCall_ijji = Module['dynCall_ijji'] = Module['asm']['oj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jdi = (Module['dynCall_jdi'] = function () {
    return (dynCall_jdi = Module['dynCall_jdi'] = Module['asm']['pj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jjji = (Module['dynCall_jjji'] = function () {
    return (dynCall_jjji = Module['dynCall_jjji'] = Module['asm']['qj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viijiiijiiii = (Module['dynCall_viijiiijiiii'] = function () {
    return (dynCall_viijiiijiiii = Module['dynCall_viijiiijiiii'] =
  ...
  var dynCall_iiji = (Module['dynCall_iiji'] = function () {
    return (dynCall_iiji = Module['dynCall_iiji'] = Module['asm']['Ej']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_j = (Module['dynCall_j'] = function () {
    return (dynCall_j = Module['dynCall_j'] = Module['asm']['Rj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_dji = (Module['dynCall_dji'] = function () {
    return (dynCall_dji = Module['dynCall_dji'] = Module['asm']['Vj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viiiiiiiiiiiiiiii = (Module[
    'dynCall_viiiiiiiiiiiiiiii'
  ] = function () {
    return (dynCall_viiiiiiiiiiiiiiii = Module['dynCall_viiiiiiiiiiiiiiii'] =
      Module['asm']['ak']).apply(null, arguments)
  })
  var dynCall_viiiiiiiiiiiiiiiii = (Module[
    'dynCall_viiiiiiiiiiiiiiiii'
  ] = function () {
    return (dynCall_viiiiiiiiiiiiiiiii = Module['dynCall_viiiiiiiiiiiiiiiii'] =
  ...
  var dynCall_viiiiiiifiifii = (Module['dynCall_viiiiiiifiifii'] = function () {
    return (dynCall_viiiiiiifiifii = Module['dynCall_viiiiiiifiifii'] =
  ...
  var dynCall_iifiifffii = (Module['dynCall_iifiifffii'] = function () {
    return (dynCall_iifiifffii = Module['dynCall_iifiifffii'] =
  ...
  var dynCall_iiiffifi = (Module['dynCall_iiiffifi'] = function () {
    return (dynCall_iiiffifi = Module['dynCall_iiiffifi'] =
      Module['asm']['Dk']).apply(null, arguments)
  })
  var dynCall_iiiffifii = (Module['dynCall_iiiffifii'] = function () {
    return (dynCall_iiiffifii = Module['dynCall_iiiffifii'] =
      Module['asm']['Ek']).apply(null, arguments)
  })
  ...
  var dynCall_vffi = (Module['dynCall_vffi'] = function () {
    return (dynCall_vffi = Module['dynCall_vffi'] = Module['asm']['Nk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iiiffifiii = (Module['dynCall_iiiffifiii'] = function () {
    return (dynCall_iiiffifiii = Module['dynCall_iiiffifiii'] =
      Module['asm']['Sk']).apply(null, arguments)
  })
  ...
  var dynCall_ifii = (Module['dynCall_ifii'] = function () {
    return (dynCall_ifii = Module['dynCall_ifii'] = Module['asm']['Uk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fifi = (Module['dynCall_fifi'] = function () {
    return (dynCall_fifi = Module['dynCall_fifi'] = Module['asm']['al']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iiffifii = (Module['dynCall_iiffifii'] = function () {
    return (dynCall_iiffifii = Module['dynCall_iiffifii'] =
  ...
  var dynCall_ifiiii = (Module['dynCall_ifiiii'] = function () {
    return (dynCall_ifiiii = Module['dynCall_ifiiii'] =
      Module['asm']['El']).apply(null, arguments)
  })
  ...
  var dynCall_idi = (Module['dynCall_idi'] = function () {
    return (dynCall_idi = Module['dynCall_idi'] = Module['asm']['Gl']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_idii = (Module['dynCall_idii'] = function () {
    return (dynCall_idii = Module['dynCall_idii'] = Module['asm']['Il']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ijii = (Module['dynCall_ijii'] = function () {
    return (dynCall_ijii = Module['dynCall_ijii'] = Module['asm']['Jl']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jji = (Module['dynCall_jji'] = function () {
    return (dynCall_jji = Module['dynCall_jji'] = Module['asm']['Kl']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jjii = (Module['dynCall_jjii'] = function () {
    return (dynCall_jjii = Module['dynCall_jjii'] = Module['asm']['Ll']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iddi = (Module['dynCall_iddi'] = function () {
    return (dynCall_iddi = Module['dynCall_iddi'] = Module['asm']['Pl']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viddfffi = (Module['dynCall_viddfffi'] = function () {
    return (dynCall_viddfffi = Module['dynCall_viddfffi'] =
      Module['asm']['Sl']).apply(null, arguments)
  })
  var dynCall_viidfffi = (Module['dynCall_viidfffi'] = function () {
    return (dynCall_viidfffi = Module['dynCall_viidfffi'] =
      Module['asm']['Tl']).apply(null, arguments)
  })
  var dynCall_vidifffi = (Module['dynCall_vidifffi'] = function () {
    return (dynCall_vidifffi = Module['dynCall_vidifffi'] =
      Module['asm']['Ul']).apply(null, arguments)
  })
  ...
  var dynCall_viifiifi = (Module['dynCall_viifiifi'] = function () {
    return (dynCall_viifiifi = Module['dynCall_viifiifi'] =
      Module['asm']['Zl']).apply(null, arguments)
  })
  var dynCall_vifiifi = (Module['dynCall_vifiifi'] = function () {
    return (dynCall_vifiifi = Module['dynCall_vifiifi'] =
  ...
  var dynCall_iffi = (Module['dynCall_iffi'] = function () {
    return (dynCall_iffi = Module['dynCall_iffi'] = Module['asm']['bm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ffi = (Module['dynCall_ffi'] = function () {
    return (dynCall_ffi = Module['dynCall_ffi'] = Module['asm']['gm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ffii = (Module['dynCall_ffii'] = function () {
    return (dynCall_ffii = Module['dynCall_ffii'] = Module['asm']['hm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_dddi = (Module['dynCall_dddi'] = function () {
    return (dynCall_dddi = Module['dynCall_dddi'] = Module['asm']['km']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ddi = (Module['dynCall_ddi'] = function () {
    return (dynCall_ddi = Module['dynCall_ddi'] = Module['asm']['lm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iidi = (Module['dynCall_iidi'] = function () {
    return (dynCall_iidi = Module['dynCall_iidi'] = Module['asm']['rm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jidi = (Module['dynCall_jidi'] = function () {
    return (dynCall_jidi = Module['dynCall_jidi'] = Module['asm']['sm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_diji = (Module['dynCall_diji'] = function () {
    return (dynCall_diji = Module['dynCall_diji'] = Module['asm']['tm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fidi = (Module['dynCall_fidi'] = function () {
    return (dynCall_fidi = Module['dynCall_fidi'] = Module['asm']['um']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ijiiiiiii = (Module['dynCall_ijiiiiiii'] = function () {
    return (dynCall_ijiiiiiii = Module['dynCall_ijiiiiiii'] =
  ...
  var dynCall_fffi = (Module['dynCall_fffi'] = function () {
    return (dynCall_fffi = Module['dynCall_fffi'] = Module['asm']['Hm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vfi = (Module['dynCall_vfi'] = function () {
    return (dynCall_vfi = Module['dynCall_vfi'] = Module['asm']['Im']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vjii = (Module['dynCall_vjii'] = function () {
    return (dynCall_vjii = Module['dynCall_vjii'] = Module['asm']['$m']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viiififfiiiiiii = (Module[
    'dynCall_viiififfiiiiiii'
  ] = function () {
    return (dynCall_viiififfiiiiiii = Module['dynCall_viiififfiiiiiii'] =
      Module['asm']['mn']).apply(null, arguments)
  })
  var dynCall_viiffiifiiiiiii = (Module[
    'dynCall_viiffiifiiiiiii'
  ] = function () {
  ...
  var dynCall_viiiffiifiiiiiii = (Module[
    'dynCall_viiiffiifiiiiiii'
  ] = function () {
  ...
  var dynCall_jfi = (Module['dynCall_jfi'] = function () {
    return (dynCall_jfi = Module['dynCall_jfi'] = Module['asm']['Wn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fji = (Module['dynCall_fji'] = function () {
    return (dynCall_fji = Module['dynCall_fji'] = Module['asm']['Xn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fdi = (Module['dynCall_fdi'] = function () {
    return (dynCall_fdi = Module['dynCall_fdi'] = Module['asm']['Yn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_dfi = (Module['dynCall_dfi'] = function () {
    return (dynCall_dfi = Module['dynCall_dfi'] = Module['asm']['Zn']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ddii = (Module['dynCall_ddii'] = function () {
    return (dynCall_ddii = Module['dynCall_ddii'] = Module['asm']['mo']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jdii = (Module['dynCall_jdii'] = function () {
    return (dynCall_jdii = Module['dynCall_jdii'] = Module['asm']['ro']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vfii = (Module['dynCall_vfii'] = function () {
    return (dynCall_vfii = Module['dynCall_vfii'] = Module['asm']['vo']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vdii = (Module['dynCall_vdii'] = function () {
    return (dynCall_vdii = Module['dynCall_vdii'] = Module['asm']['wo']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_didi = (Module['dynCall_didi'] = function () {
    return (dynCall_didi = Module['dynCall_didi'] = Module['asm']['Ao']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_di = (Module['dynCall_di'] = function () {
    return (dynCall_di = Module['dynCall_di'] = Module['asm']['Jo']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viiiiiiiiiiiiiiiiiii = (Module[
  ...
  var dynCall_iiiiiiiiiiiiiii = (Module[
  ...
  var dynCall_iiiiiiiiiiiiiiiii = (Module[
  ...
  var dynCall_iiiiiiiiiiiiiiiiii = (Module[
    ...
    return (dynCall_iiiiiiiiiiiiiiiiii = Module['dynCall_iiiiiiiiiiiiiiiiii'] =
  ...
  var dynCall_ijj = (Module['dynCall_ijj'] = function () {
    return (dynCall_ijj = Module['dynCall_ijj'] = Module['asm']['Vo']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vjji = (Module['dynCall_vjji'] = function () {
    return (dynCall_vjji = Module['dynCall_vjji'] = Module['asm']['Wo']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ij = (Module['dynCall_ij'] = function () {
    return (dynCall_ij = Module['dynCall_ij'] = Module['asm']['Xo']).apply(
      null,
      arguments,
    )
  })
  var dynCall_viif = (Module['dynCall_viif'] = function () {
    return (dynCall_viif = Module['dynCall_viif'] = Module['asm']['Yo']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vid = (Module['dynCall_vid'] = function () {
    return (dynCall_vid = Module['dynCall_vid'] = Module['asm']['Zo']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vif = (Module['dynCall_vif'] = function () {
    return (dynCall_vif = Module['dynCall_vif'] = Module['asm']['_o']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vidd = (Module['dynCall_vidd'] = function () {
    return (dynCall_vidd = Module['dynCall_vidd'] = Module['asm']['dp']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vf = (Module['dynCall_vf'] = function () {
    return (dynCall_vf = Module['dynCall_vf'] = Module['asm']['hp']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vff = (Module['dynCall_vff'] = function () {
    return (dynCall_vff = Module['dynCall_vff'] = Module['asm']['jp']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viff = (Module['dynCall_viff'] = function () {
    return (dynCall_viff = Module['dynCall_viff'] = Module['asm']['mp']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vij = (Module['dynCall_vij'] = function () {
    return (dynCall_vij = Module['dynCall_vij'] = Module['asm']['np']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fff = (Module['dynCall_fff'] = function () {
    return (dynCall_fff = Module['dynCall_fff'] = Module['asm']['op']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fif = (Module['dynCall_fif'] = function () {
    return (dynCall_fif = Module['dynCall_fif'] = Module['asm']['qp']).apply(
      null,
      arguments,
    )
  })
  var dynCall_f = (Module['dynCall_f'] = function () {
    return (dynCall_f = Module['dynCall_f'] = Module['asm']['rp']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vfff = (Module['dynCall_vfff'] = function () {
    return (dynCall_vfff = Module['dynCall_vfff'] = Module['asm']['sp']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ff = (Module['dynCall_ff'] = function () {
    return (dynCall_ff = Module['dynCall_ff'] = Module['asm']['up']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fiif = (Module['dynCall_fiif'] = function () {
    return (dynCall_fiif = Module['dynCall_fiif'] = Module['asm']['vp']).apply(
      null,
      arguments,
    )
  })
  ...
  function invoke_viiiiiiifiifii(
    index,
    a1,
    a2,
    a3,
