function unityFramework(Module) {
  ...
  function createWasm() {
    ...
    function receiveInstance(instance, module) {
      ...
      Module['asm'] = exports
      wasmMemory = Module['asm']['Mh']
      updateGlobalBufferAndViews(wasmMemory.buffer)
      wasmTable = Module['asm']['ji']
      addOnInit(Module['asm']['Nh'])
  ...
  var asmLibraryArg = {
    ec: _CastCard,
    xe: _JS_Accelerometer_IsRunning,
    db: _JS_Accelerometer_Start,
    we: _JS_Accelerometer_Stop,
    De: _JS_Cursor_SetImage,
    va: _JS_Cursor_SetShow,
    ya: _JS_DOM_MapViewportCoordinateToElementLocalCoordinate,
    Dg: _JS_DOM_UnityCanvasSelector,
    _d: _JS_FileSystem_Initialize,
    V: _JS_FileSystem_Sync,
    te: _JS_GravitySensor_IsRunning,
    bb: _JS_GravitySensor_Start,
    se: _JS_GravitySensor_Stop,
    re: _JS_Gyroscope_IsRunning,
    ab: _JS_Gyroscope_Start,
    qe: _JS_Gyroscope_Stop,
    ve: _JS_LinearAccelerationSensor_IsRunning,
    cb: _JS_LinearAccelerationSensor_Start,
    ue: _JS_LinearAccelerationSensor_Stop,
    qc: _JS_Log_Dump,
    ce: _JS_Log_StackTrace,
    Ae: _JS_OrientationSensor_IsRunning,
    eb: _JS_OrientationSensor_Start,
    ze: _JS_OrientationSensor_Stop,
    ib: _JS_RequestDeviceSensorPermissionsOnTouch,
    Td: _JS_RunQuitCallbacks,
    pe: _JS_ScreenOrientation_DeInit,
    Be: _JS_ScreenOrientation_Init,
    _: _JS_ScreenOrientation_Lock,
    jb: _JS_Sound_ResumeIfNeeded,
    oe: _JS_SystemInfo_GetCanvasClientSize,
    Me: _JS_SystemInfo_GetDocumentURL,
    Yd: _JS_SystemInfo_GetGPUInfo,
    $a: _JS_SystemInfo_GetMatchWebGLToCanvasSize,
    Wa: _JS_SystemInfo_GetMemory,
    be: _JS_SystemInfo_GetOS,
    Za: _JS_SystemInfo_GetPreferredDevicePixelRatio,
    ee: _JS_SystemInfo_GetScreenSize,
    af: _JS_SystemInfo_GetStreamingAssetsURL,
    Fe: _JS_SystemInfo_HasAstcHdr,
    Ya: _JS_SystemInfo_HasCursorLock,
    ne: _JS_SystemInfo_HasFullscreen,
    la: _JS_SystemInfo_HasWebGL,
    Ee: _JS_SystemInfo_IsMobile,
    ae: _JS_UnityEngineShouldQuit,
    We: _JS_WebRequest_Abort,
    Te: _JS_WebRequest_Create,
    Ue: _JS_WebRequest_GetResponseHeaders,
    Ve: _JS_WebRequest_Release,
    Ne: _JS_WebRequest_Send,
    Pe: _JS_WebRequest_SetProgressHandler,
    Oe: _JS_WebRequest_SetRequestHeader,
    Re: _JS_WebRequest_SetResponseHandler,
    Se: _JS_WebRequest_SetTimeout,
    fc: _OnGameOverPopupButtonClicked,
    Bh: _OnUnityLoaded,
    Ah: _OpenLinkInNewTab,
    wh: _WebGLInputCreate,
    cc: _WebGLInputDelete,
    vh: _WebGLInputEnterSubmit,
    La: _WebGLInputFocus,
    mh: _WebGLInputIsFocus,
    oh: _WebGLInputMaxLength,
    xh: _WebGLInputMobileOnFocusOut,
    yh: _WebGLInputMobileRegister,
    sh: _WebGLInputOnBlur,
    qh: _WebGLInputOnEditEnd,
    th: _WebGLInputOnFocus,
    rh: _WebGLInputOnValueChange,
    dc: _WebGLInputSelectionDirection,
    Ja: _WebGLInputSelectionEnd,
    Ka: _WebGLInputSelectionStart,
    ph: _WebGLInputSetSelectionRange,
    uh: _WebGLInputTab,
    nh: _WebGLInputText,
    bc: _WebGLWindowInjectFullscreen,
    kh: _WebGLWindowOnBlur,
    lh: _WebGLWindowOnFocus,
    ...
    zb: ___cxa_free_exception,
    ye: ___cxa_rethrow,
    aa: ___cxa_throw,
    Ec: ___gmtime_r,
    Fc: ___localtime_r,
    l: ___resumeException,
    Lc: ___sys__newselect,
    Qc: ___sys_accept4,
    Mc: ___sys_access,
    Wc: ___sys_bind,
    tc: ___sys_chmod,
    ...
    M: ___sys_fcntl64,
    ie: ___sys_fstat64,
    Ud: ___sys_ftruncate64,
    pc: ___sys_getcwd,
    mc: ___sys_getdents64,
    jc: ___sys_getegid32,
    kc: ___sys_geteuid32,
    Bc: ___sys_getpeername,
    pa: ___sys_getpid,
    Kc: ___sys_getrusage,
    Sc: ___sys_getsockname,
    Vc: ___sys_getsockopt,
    $e: ___sys_getuid32,
    Ta: ___sys_ioctl,
    Rc: ___sys_listen,
    uc: ___sys_lstat64,
    ...
    xc: ___sys_sendmsg,
    Pc: ___sys_sendto,
    Nc: ___sys_setsockopt,
    zc: ___sys_shutdown,
    Pa: ___sys_socket,
    Xa: ___sys_stat64,
    Xe: ___sys_statfs64,
    Ye: ___sys_truncate64,
    Hc: ___sys_uname,
    sc: ___sys_unlink,
    D: _abort,
    L: _clock,
    ...
    Vd: _emscripten_cancel_main_loop,
    Sd: _emscripten_clear_interval,
    ...
    $d: _emscripten_set_main_loop_timing,
    ...
    bf: _emscripten_webgl_init_context_attributes,
    Aa: _emscripten_webgl_make_context_current,
    Ac: _environ_get,
    Gc: _environ_sizes_get,
    ea: _exit,
    S: _fd_close,
    Ua: _fd_fdstat_get,
    Sa: _fd_read,
    ...
    _g: _glAttachShader,
    Db: _glBeginQuery,
    Pf: _glBeginTransformFeedback,
    na: _glBindAttribLocation,
    Zg: _glBindBuffer,
    pf: _glBindBufferBase,
    of: _glBindBufferRange,
    Wg: _glBindFramebuffer,
    Xg: _glBindRenderbuffer,
    jf: _glBindSampler,
    Yg: _glBindTexture,
    If: _glBindTransformFeedback,
    Lf: _glBindVertexArray,
    _b: _glBlendEquation,
    $b: _glBlendEquationSeparate,
    ac: _glBlendFuncSeparate,
    Af: _glBlitFramebuffer,
    Ug: _glBufferData,
    Vg: _glBufferSubData,
    Tg: _glCheckFramebufferStatus,
    Pg: _glClear,
    ef: _glClearBufferfi,
    df: _glClearBufferfv,
    cf: _glClearBufferuiv,
    Qg: _glClearColor,
    Rg: _glClearDepthf,
    Sg: _glClearStencil,
    ...
    Zb: _glColorMask,
    Og: _glCompileShader,
    Mg: _glCompressedTexImage2D,
    Cf: _glCompressedTexImage3D,
    Ng: _glCompressedTexSubImage2D,
    Gf: _glCompressedTexSubImage3D,
    sf: _glCopyBufferSubData,
    Lg: _glCopyTexImage2D,
    Yb: _glCopyTexSubImage2D,
    Kg: _glCreateProgram,
    Jg: _glCreateShader,
    Ig: _glCullFace,
    Hg: _glDeleteBuffers,
    Gg: _glDeleteFramebuffers,
    Fg: _glDeleteProgram,
    Cb: _glDeleteQueries,
    Eg: _glDeleteRenderbuffers,
    hf: _glDeleteSamplers,
    Cg: _glDeleteShader,
    wb: _glDeleteSync,
    Bg: _glDeleteTextures,
    Jf: _glDeleteTransformFeedbacks,
    Nf: _glDeleteVertexArrays,
    Xb: _glDepthFunc,
    Wb: _glDepthMask,
    Ag: _glDetachShader,
    zg: _glDisable,
    yg: _glDisableVertexAttribArray,
    vg: _glDrawArrays,
    uf: _glDrawArraysInstanced,
    rf: _glDrawBuffers,
    wg: _glDrawElements,
    tf: _glDrawElementsInstanced,
    xg: _glEnable,
    ug: _glEnableVertexAttribArray,
    Eb: _glEndQuery,
    Qf: _glEndTransformFeedback,
    vb: _glFenceSync,
    rg: _glFinish,
    sg: _glFlush,
    xf: _glFlushMappedBufferRange,
    O: _glFramebufferRenderbuffer,
    N: _glFramebufferTexture2D,
    Da: _glFramebufferTextureLayer,
    Vb: _glFrontFace,
    qg: _glGenBuffers,
    mg: _glGenFramebuffers,
    Bb: _glGenQueries,
    ng: _glGenRenderbuffers,
    gf: _glGenSamplers,
    pg: _glGenTextures,
    Kf: _glGenTransformFeedbacks,
    Of: _glGenVertexArrays,
    og: _glGenerateMipmap,
    ...
    lg: _glGetError,
    kg: _glGetFramebufferAttachmentParameteriv,
    ah: _glGetIntegeri_v,
    oa: _glGetIntegerv,
    lf: _glGetInternalformativ,
    xb: _glGetProgramBinary,
    dh: _glGetProgramInfoLog,
    R: _glGetProgramiv,
    Sf: _glGetQueryObjectuiv,
    Rf: _glGetQueryiv,
    tg: _glGetRenderbufferParameteriv,
    ig: _glGetShaderInfoLog,
    Ub: _glGetShaderPrecisionFormat,
    jg: _glGetShaderSource,
    ch: _glGetShaderiv,
    hg: _glGetString,
    yf: _glGetStringi,
    gg: _glGetTexParameteriv,
    mf: _glGetUniformBlockIndex,
    ...
    Mf: _glIsVertexArray,
    eg: _glLinkProgram,
    vf: _glMapBufferRange,
    fg: _glPixelStorei,
    Sb: _glPolygonOffset,
    yb: _glProgramBinary,
    ff: _glProgramParameteri,
    qf: _glReadBuffer,
    ca: _glReadPixels,
    dg: _glRenderbufferStorage,
    zf: _glRenderbufferStorageMultisample,
    kf: _glSamplerParameteri,
    Rb: _glScissor,
    bg: _glShaderSource,
    cg: _glStencilFuncSeparate,
    $f: _glStencilMask,
    ag: _glStencilOpSeparate,
    Zf: _glTexImage2D,
    Ef: _glTexImage3D,
    _f: _glTexParameterf,
    Ha: _glTexParameteri,
    ...
    Xf: _glTexSubImage2D,
    Ff: _glTexSubImage3D,
    Hf: _glTransformFeedbackVaryings,
    Gb: _glUniform1fv,
    ma: _glUniform1i,
    Hb: _glUniform1iv,
    Ib: _glUniform1uiv,
    ...
    s: invoke_viiiiii,
    C: invoke_viiiiiii,
    Eh: invoke_viiiiiiifiifii,
    G: invoke_viiiiiiii,
    K: invoke_viiiiiiiii,
    gc: invoke_viiiiiiiiifi,
    fa: invoke_viiiiiiiiii,
    ic: invoke_viiiiiiiiiiii,
    cd: invoke_viiiiij,
    dd: invoke_viiiijii,
    Dd: invoke_viiij,
    gd: invoke_viiiji,
    ...
    Ed: invoke_viiji,
    Jd: invoke_viijii,
    _c: invoke_viijiiiiii,
    zd: invoke_viijiiijiiii,
    Fd: invoke_viji,
    qd: invoke_vijii,
    bd: invoke_vijiii,
    ud: invoke_vijiiii,
  ...
  var _SendMessage = (Module['_SendMessage'] = function () {
    return (_SendMessage = Module['_SendMessage'] = Module['asm']['Qh']).apply(
      null,
      arguments,
    )
  })
  ...
  var _main = (Module['_main'] = function () {
    return (_main = Module['_main'] = Module['asm']['Sh']).apply(
      null,
      arguments,
    )
  })
  ...
  var _htonl = (Module['_htonl'] = function () {
    return (_htonl = Module['_htonl'] = Module['asm']['Uh']).apply(
      null,
      arguments,
    )
  })
  var _htons = (Module['_htons'] = function () {
    return (_htons = Module['_htons'] = Module['asm']['Vh']).apply(
      null,
      arguments,
    )
  })
  var _ntohs = (Module['_ntohs'] = function () {
    return (_ntohs = Module['_ntohs'] = Module['asm']['Wh']).apply(
      null,
      arguments,
    )
  })
  var __get_tzname = (Module['__get_tzname'] = function () {
    return (__get_tzname = Module['__get_tzname'] = Module['asm']['Xh']).apply(
      null,
      arguments,
    )
  })
  ...
  var stackSave = (Module['stackSave'] = function () {
    return (stackSave = Module['stackSave'] = Module['asm']['_h']).apply(
      null,
      arguments,
    )
  })
  ...
  var stackAlloc = (Module['stackAlloc'] = function () {
    return (stackAlloc = Module['stackAlloc'] = Module['asm']['ai']).apply(
      null,
      arguments,
    )
  })
  var _setThrew = (Module['_setThrew'] = function () {
    return (_setThrew = Module['_setThrew'] = Module['asm']['bi']).apply(
      null,
      arguments,
    )
  })
  ...
  var _malloc = (Module['_malloc'] = function () {
    return (_malloc = Module['_malloc'] = Module['asm']['ei']).apply(
      null,
      arguments,
    )
  })
  var _free = (Module['_free'] = function () {
    return (_free = Module['_free'] = Module['asm']['fi']).apply(
      null,
      arguments,
    )
  })
  var _memalign = (Module['_memalign'] = function () {
    return (_memalign = Module['_memalign'] = Module['asm']['gi']).apply(
      null,
      arguments,
    )
  })
  var _memset = (Module['_memset'] = function () {
    return (_memset = Module['_memset'] = Module['asm']['hi']).apply(
      null,
      arguments,
    )
  })
  var _strlen = (Module['_strlen'] = function () {
    return (_strlen = Module['_strlen'] = Module['asm']['ii']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vii = (Module['dynCall_vii'] = function () {
    return (dynCall_vii = Module['dynCall_vii'] = Module['asm']['li']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iii = (Module['dynCall_iii'] = function () {
    return (dynCall_iii = Module['dynCall_iii'] = Module['asm']['mi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ii = (Module['dynCall_ii'] = function () {
    return (dynCall_ii = Module['dynCall_ii'] = Module['asm']['ni']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iiii = (Module['dynCall_iiii'] = function () {
    return (dynCall_iiii = Module['dynCall_iiii'] = Module['asm']['oi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jiji = (Module['dynCall_jiji'] = function () {
    return (dynCall_jiji = Module['dynCall_jiji'] = Module['asm']['pi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_v = (Module['dynCall_v'] = function () {
    return (dynCall_v = Module['dynCall_v'] = Module['asm']['si']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vi = (Module['dynCall_vi'] = function () {
    return (dynCall_vi = Module['dynCall_vi'] = Module['asm']['ti']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viii = (Module['dynCall_viii'] = function () {
    return (dynCall_viii = Module['dynCall_viii'] = Module['asm']['xi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iiij = (Module['dynCall_iiij'] = function () {
    return (dynCall_iiij = Module['dynCall_iiij'] = Module['asm']['yi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iij = (Module['dynCall_iij'] = function () {
    return (dynCall_iij = Module['dynCall_iij'] = Module['asm']['Ci']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jii = (Module['dynCall_jii'] = function () {
    return (dynCall_jii = Module['dynCall_jii'] = Module['asm']['Ei']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fii = (Module['dynCall_fii'] = function () {
    return (dynCall_fii = Module['dynCall_fii'] = Module['asm']['Hi']).apply(
      null,
      arguments,
    )
  })
  var dynCall_dii = (Module['dynCall_dii'] = function () {
    return (dynCall_dii = Module['dynCall_dii'] = Module['asm']['Ii']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vidi = (Module['dynCall_vidi'] = function () {
    return (dynCall_vidi = Module['dynCall_vidi'] = Module['asm']['Ji']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vifi = (Module['dynCall_vifi'] = function () {
    return (dynCall_vifi = Module['dynCall_vifi'] = Module['asm']['Ki']).apply(
      null,
      arguments,
    )
  })
  var dynCall_viji = (Module['dynCall_viji'] = function () {
    return (dynCall_viji = Module['dynCall_viji'] = Module['asm']['Li']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ji = (Module['dynCall_ji'] = function () {
    return (dynCall_ji = Module['dynCall_ji'] = Module['asm']['Ti']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jjji = (Module['dynCall_jjji'] = function () {
    return (dynCall_jjji = Module['dynCall_jjji'] = Module['asm']['Ui']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ijji = (Module['dynCall_ijji'] = function () {
    return (dynCall_ijji = Module['dynCall_ijji'] = Module['asm']['Xi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jdi = (Module['dynCall_jdi'] = function () {
    return (dynCall_jdi = Module['dynCall_jdi'] = Module['asm']['Zi']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iiji = (Module['dynCall_iiji'] = function () {
    return (dynCall_iiji = Module['dynCall_iiji'] = Module['asm']['cj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_iji = (Module['dynCall_iji'] = function () {
    return (dynCall_iji = Module['dynCall_iji'] = Module['asm']['dj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viij = (Module['dynCall_viij'] = function () {
    return (dynCall_viij = Module['dynCall_viij'] = Module['asm']['ij']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fi = (Module['dynCall_fi'] = function () {
    return (dynCall_fi = Module['dynCall_fi'] = Module['asm']['mj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fiii = (Module['dynCall_fiii'] = function () {
    return (dynCall_fiii = Module['dynCall_fiii'] = Module['asm']['sj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_j = (Module['dynCall_j'] = function () {
    return (dynCall_j = Module['dynCall_j'] = Module['asm']['Fj']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jijj = (Module['dynCall_jijj'] = function () {
    return (dynCall_jijj = Module['dynCall_jijj'] = Module['asm']['Gj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vji = (Module['dynCall_vji'] = function () {
    return (dynCall_vji = Module['dynCall_vji'] = Module['asm']['Ij']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_diii = (Module['dynCall_diii'] = function () {
    return (dynCall_diii = Module['dynCall_diii'] = Module['asm']['Kj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_dji = (Module['dynCall_dji'] = function () {
    return (dynCall_dji = Module['dynCall_dji'] = Module['asm']['Sj']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vffi = (Module['dynCall_vffi'] = function () {
    return (dynCall_vffi = Module['dynCall_vffi'] = Module['asm']['Jk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ifii = (Module['dynCall_ifii'] = function () {
    return (dynCall_ifii = Module['dynCall_ifii'] = Module['asm']['Qk']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ifi = (Module['dynCall_ifi'] = function () {
    return (dynCall_ifi = Module['dynCall_ifi'] = Module['asm']['zl']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_idi = (Module['dynCall_idi'] = function () {
    return (dynCall_idi = Module['dynCall_idi'] = Module['asm']['Cl']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_idii = (Module['dynCall_idii'] = function () {
    return (dynCall_idii = Module['dynCall_idii'] = Module['asm']['El']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ijii = (Module['dynCall_ijii'] = function () {
    return (dynCall_ijii = Module['dynCall_ijii'] = Module['asm']['Fl']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jji = (Module['dynCall_jji'] = function () {
    return (dynCall_jji = Module['dynCall_jji'] = Module['asm']['Gl']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jjii = (Module['dynCall_jjii'] = function () {
    return (dynCall_jjii = Module['dynCall_jjii'] = Module['asm']['Hl']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iddi = (Module['dynCall_iddi'] = function () {
    return (dynCall_iddi = Module['dynCall_iddi'] = Module['asm']['Ll']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iffi = (Module['dynCall_iffi'] = function () {
    return (dynCall_iffi = Module['dynCall_iffi'] = Module['asm']['Zl']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ffi = (Module['dynCall_ffi'] = function () {
    return (dynCall_ffi = Module['dynCall_ffi'] = Module['asm']['cm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ffii = (Module['dynCall_ffii'] = function () {
    return (dynCall_ffii = Module['dynCall_ffii'] = Module['asm']['dm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_dddi = (Module['dynCall_dddi'] = function () {
    return (dynCall_dddi = Module['dynCall_dddi'] = Module['asm']['gm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ddi = (Module['dynCall_ddi'] = function () {
    return (dynCall_ddi = Module['dynCall_ddi'] = Module['asm']['hm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_iidi = (Module['dynCall_iidi'] = function () {
    return (dynCall_iidi = Module['dynCall_iidi'] = Module['asm']['nm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_jidi = (Module['dynCall_jidi'] = function () {
    return (dynCall_jidi = Module['dynCall_jidi'] = Module['asm']['om']).apply(
      null,
      arguments,
    )
  })
  var dynCall_diji = (Module['dynCall_diji'] = function () {
    return (dynCall_diji = Module['dynCall_diji'] = Module['asm']['pm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fidi = (Module['dynCall_fidi'] = function () {
    return (dynCall_fidi = Module['dynCall_fidi'] = Module['asm']['qm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fffi = (Module['dynCall_fffi'] = function () {
    return (dynCall_fffi = Module['dynCall_fffi'] = Module['asm']['Dm']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vfi = (Module['dynCall_vfi'] = function () {
    return (dynCall_vfi = Module['dynCall_vfi'] = Module['asm']['Em']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vjii = (Module['dynCall_vjii'] = function () {
    return (dynCall_vjii = Module['dynCall_vjii'] = Module['asm']['Xm']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jfi = (Module['dynCall_jfi'] = function () {
    return (dynCall_jfi = Module['dynCall_jfi'] = Module['asm']['Tn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fji = (Module['dynCall_fji'] = function () {
    return (dynCall_fji = Module['dynCall_fji'] = Module['asm']['Un']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fdi = (Module['dynCall_fdi'] = function () {
    return (dynCall_fdi = Module['dynCall_fdi'] = Module['asm']['Vn']).apply(
      null,
      arguments,
    )
  })
  var dynCall_dfi = (Module['dynCall_dfi'] = function () {
    return (dynCall_dfi = Module['dynCall_dfi'] = Module['asm']['Wn']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ddii = (Module['dynCall_ddii'] = function () {
    return (dynCall_ddii = Module['dynCall_ddii'] = Module['asm']['jo']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_jdii = (Module['dynCall_jdii'] = function () {
    return (dynCall_jdii = Module['dynCall_jdii'] = Module['asm']['oo']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vfii = (Module['dynCall_vfii'] = function () {
    return (dynCall_vfii = Module['dynCall_vfii'] = Module['asm']['so']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vdii = (Module['dynCall_vdii'] = function () {
    return (dynCall_vdii = Module['dynCall_vdii'] = Module['asm']['to']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_didi = (Module['dynCall_didi'] = function () {
    return (dynCall_didi = Module['dynCall_didi'] = Module['asm']['xo']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_di = (Module['dynCall_di'] = function () {
    return (dynCall_di = Module['dynCall_di'] = Module['asm']['Go']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ijj = (Module['dynCall_ijj'] = function () {
    return (dynCall_ijj = Module['dynCall_ijj'] = Module['asm']['So']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vjji = (Module['dynCall_vjji'] = function () {
    return (dynCall_vjji = Module['dynCall_vjji'] = Module['asm']['To']).apply(
      null,
      arguments,
    )
  })
  var dynCall_ij = (Module['dynCall_ij'] = function () {
    return (dynCall_ij = Module['dynCall_ij'] = Module['asm']['Uo']).apply(
      null,
      arguments,
    )
  })
  var dynCall_viif = (Module['dynCall_viif'] = function () {
    return (dynCall_viif = Module['dynCall_viif'] = Module['asm']['Vo']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vid = (Module['dynCall_vid'] = function () {
    return (dynCall_vid = Module['dynCall_vid'] = Module['asm']['Wo']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vif = (Module['dynCall_vif'] = function () {
    return (dynCall_vif = Module['dynCall_vif'] = Module['asm']['Xo']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vidd = (Module['dynCall_vidd'] = function () {
    return (dynCall_vidd = Module['dynCall_vidd'] = Module['asm']['ap']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vf = (Module['dynCall_vf'] = function () {
    return (dynCall_vf = Module['dynCall_vf'] = Module['asm']['ep']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_vff = (Module['dynCall_vff'] = function () {
    return (dynCall_vff = Module['dynCall_vff'] = Module['asm']['gp']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_viff = (Module['dynCall_viff'] = function () {
    return (dynCall_viff = Module['dynCall_viff'] = Module['asm']['jp']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vij = (Module['dynCall_vij'] = function () {
    return (dynCall_vij = Module['dynCall_vij'] = Module['asm']['kp']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fff = (Module['dynCall_fff'] = function () {
    return (dynCall_fff = Module['dynCall_fff'] = Module['asm']['lp']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_fif = (Module['dynCall_fif'] = function () {
    return (dynCall_fif = Module['dynCall_fif'] = Module['asm']['np']).apply(
      null,
      arguments,
    )
  })
  var dynCall_f = (Module['dynCall_f'] = function () {
    return (dynCall_f = Module['dynCall_f'] = Module['asm']['op']).apply(
      null,
      arguments,
    )
  })
  var dynCall_vfff = (Module['dynCall_vfff'] = function () {
    return (dynCall_vfff = Module['dynCall_vfff'] = Module['asm']['pp']).apply(
      null,
      arguments,
    )
  })
  ...
  var dynCall_ff = (Module['dynCall_ff'] = function () {
    return (dynCall_ff = Module['dynCall_ff'] = Module['asm']['rp']).apply(
      null,
      arguments,
    )
  })
  var dynCall_fiif = (Module['dynCall_fiif'] = function () {
    return (dynCall_fiif = Module['dynCall_fiif'] = Module['asm']['sp']).apply(
      null,
      arguments,
    )
  })
